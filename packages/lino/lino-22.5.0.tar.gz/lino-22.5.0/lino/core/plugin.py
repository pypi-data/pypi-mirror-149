...
class Plugin(object):
    ...
    @classmethod
    def setup_site_features(cls, feats):
        """
        arguments:
            feats: The instance of :class:`lino.core.features.Features`. Also
            accessible through :class:`Plugin` attribute :attr:`Plugin.feature`.
        """
        pass
