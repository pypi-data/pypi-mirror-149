...
class Dataset(google.protobuf.message.Message):
    ...
    class _DatasetTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Dataset._DatasetType.ValueType], builtins.type):
        ...
        DATASET_TYPE_SQL: Dataset._DatasetType.ValueType  # 3
        DATASET_TYPE_SPARK: Dataset._DatasetType.ValueType  # 4
    ...
    DATASET_TYPE_SQL: Dataset.DatasetType.ValueType  # 3
    DATASET_TYPE_SPARK: Dataset.DatasetType.ValueType  # 4
    ...
    def HasField(self, field_name: typing_extensions.Literal["created_by_id",b"created_by_id","data_source_id",b"data_source_id","default_build_id",b"default_build_id","derived_dataset_build_details",b"derived_dataset_build_details","id",b"id","organization_id",b"organization_id","owners",b"owners","project_id",b"project_id","python_dataset",b"python_dataset","spark_dataset",b"spark_dataset","sql_dataset",b"sql_dataset"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["created_by_id",b"created_by_id","created_timestamp",b"created_timestamp","data_source_id",b"data_source_id","default_build_id",b"default_build_id","derived_dataset_build_details",b"derived_dataset_build_details","description",b"description","downloads",b"downloads","format",b"format","id",b"id","likes",b"likes","name",b"name","organization_id",b"organization_id","owners",b"owners","project_id",b"project_id","project_name",b"project_name","python_dataset",b"python_dataset","spark_dataset",b"spark_dataset","sql_dataset",b"sql_dataset","type",b"type","updated_timestamp",b"updated_timestamp"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["derived_dataset_build_details",b"derived_dataset_build_details"]) -> typing.Optional[typing_extensions.Literal["sql_dataset","python_dataset","spark_dataset"]]: ...
