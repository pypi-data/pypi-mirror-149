...
class SparkFeature(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["aggregations",b"aggregations","created_by_id",b"created_by_id","created_timestamp",b"created_timestamp","description",b"description","fabric",b"fabric","id",b"id","name",b"name","organization_id",b"organization_id","python_source_content",b"python_source_content","python_source_entrypoint",b"python_source_entrypoint","s3_path",b"s3_path","updated_timestamp",b"updated_timestamp"]) -> None: ...
global___SparkFeature = SparkFeature
