...
def log(
    ...
    This function can only be run inside functions decorated with @model or @dataset.
    The logged data can then be discovered and analyzed through the Layer UI. We support Python primitives, images, tables and plots to enable better experiment tracking and version comparison.
