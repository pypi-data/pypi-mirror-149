...
class RemoteExecutionProjectProgressTracker(ProjectProgressTracker):
    ...
    def mark_model_resources_uploading(self, name: str) -> None:
        self._update_entity(EntityType.MODEL, name, description="uploading")

    def mark_model_resources_uploaded(self, name: str) -> None:
        self._update_entity(EntityType.MODEL, name, description="uploaded")

    def mark_dataset_resources_uploading(self, name: str) -> None:
        self._update_entity(EntityType.DERIVED_DATASET, name, description="uploading")

    def mark_dataset_resources_uploaded(self, name: str) -> None:
        self._update_entity(EntityType.DERIVED_DATASET, name, description="uploaded")
