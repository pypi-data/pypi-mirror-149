...
details = {
    #! 'Changelog' : 'https://github.com/Defxult/reactionmenu/blob/main/CHANGELOG.md' - Uncomment this when it's time for release
    'Changelog' : 'https://github.com/Defxult/reactionmenu/blob/discord.py-2.0-support/CHANGELOG.md'
}
