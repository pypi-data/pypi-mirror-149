...
def parse_multi(parser):
    ...
    parser.add_argument('--cDNAconfig', metavar='JASON',help='whitelist of cell barcode and structure file in JSON format for cDNA fastq, [defalut: %s/config/DNBelabC4_scRNA_beads_readStructure.json].'%_root_dir)
    parser.add_argument('--oligoconfig', metavar='JASON',help='whitelist of cell barcode and structure file in JSON format for oligo fastq, [defalut: %s/config/DNBelabC4_scRNA_oligo_readStructure.json].'%_root_dir,)
    parser.add_argument('--oligotype', metavar='FILE',help='Whitelist of oligo index, [default: %s/config/oligo_type8.txt].'%_root_dir)
    ...
    parser.add_argument('--minumi',metavar='INT',help='The min umi for use emptydrops, [default: 500].')
    parser.add_argument('--process', metavar='TEXT',help='Custom your analysis steps, steps are separated by comma, [default: data,count,analysis,report].')
