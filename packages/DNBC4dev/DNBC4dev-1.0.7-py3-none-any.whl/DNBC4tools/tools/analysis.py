...
def parse_analysis(parser):
    ...
    parser.add_argument('--mitpercentage',metavar='INT',type=int,default=5,help='Filter cells with mtgenes percentage, [default: 5].')
    parser.add_argument('--mtgenes',metavar='LIST',default='False',help='Set mitochondrial genes(mtgene list file path) or False, [default: False].')
