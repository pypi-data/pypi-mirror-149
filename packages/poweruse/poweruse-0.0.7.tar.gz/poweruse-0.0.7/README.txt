...
ctime() -> return current time

vi(filename, extension) --> make VI file

running() --> cmd top command

folder(name) --> create a name

malDB() --> EDU Purposes only.
