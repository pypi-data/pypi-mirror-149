...
osc(command) -> run cmd command

bin(value) -> turn to binary

center(values, break) --> equal to python center command

copy(list, newname) --> copy contents of a list

split(values, token) --> same as partition() in py3

filec(filename, extension) --> new file
