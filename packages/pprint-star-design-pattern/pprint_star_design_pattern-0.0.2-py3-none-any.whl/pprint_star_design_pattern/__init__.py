...
| 20.  hourglass(row=8)                                                             |
| 21.  vertical_parallel_bar(width=5,space=10,row=10)                               |
| 22.  add_vertical_empty_space(row=10)                                             |
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
def horizontal_single_line(width=10, row=1):
...
def vertical_parallel_bar(width=5,space=10,row=10):
  for i in range(1,row+1):
    print(width * '*' + space * ' ' + width * '*')


def add_vertical_empty_space(row=10):
  for i in range(1,row+1):
    print('')