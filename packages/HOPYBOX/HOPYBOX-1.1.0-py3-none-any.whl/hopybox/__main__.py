...
from .caculate import caculate,root_caculate
from .translate import translate
from .findipway import way_four
from .filetoolbox import read_file
from .hearmesay import Codesay
from .weather import city
print('\033[96mWELCOME TO HOPYBOX\033[0m\033[92m [{}]\033[0m\n{}'.format(getuser().upper(),version))
pattern = 'Command'
codesay = Codesay()
while True:
  ...
  if answer == 'exit':
    ...
    pattern = 'Command'
    print('\033[96mProgram mode switched successfully')
  ...
  #Command
    ...
    if answer == 'help':
      ...
      caculate(answer[9:])
    elif answer[:14] == 'root caculate ':
      root_caculate(answer[14:])
      ...
      city(answer[8:])
    elif answer == 'codesay 1':
      codesay.listenmesay1()
    elif answer == 'codesay 2':
      codesay.listenmesay2()
    elif not answer:
