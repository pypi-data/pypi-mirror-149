...
class qasm3ParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by qasm3Parser#nonArrayType.
    ...
    # Visit a parse tree produced by qasm3Parser#arrayReferenceTypeDimensionSpecifier.
    def visitArrayReferenceTypeDimensionSpecifier(self, ctx:qasm3Parser.ArrayReferenceTypeDimensionSpecifierContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by qasm3Parser#arrayInitializer.
    def visitArrayInitializer(self, ctx:qasm3Parser.ArrayInitializerContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by qasm3Parser#arrayDeclaration.
    ...
    # Visit a parse tree produced by qasm3Parser#aliasInitializer.
