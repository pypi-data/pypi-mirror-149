...
['PySocks>=1.5.6,!=1.5.7,<2.0.0',
 ...
 'rpaframework-dialogs>=2.0.0,<3.0.0',
 'rpaframework-pdf>=3.0.0,<4.0.0',
...
{':python_full_version < "3.7.6" and sys_platform == "win32" or python_full_version > "3.7.6" and python_full_version < "3.8.1" and sys_platform == "win32" or python_full_version > "3.8.1" and sys_platform == "win32"': ['pywinauto>=0.6.8,<0.7.0',
 ...
 ':sys_platform == "win32"': ['rpaframework-windows>=4.0.0,<5.0.0',
                              'robotframework-sapguilibrary>=1.1,<2.0',
                              'comtypes==1.1.11',
                              'psutil>=5.7.0,<6.0.0'],
 'aws': ['rpaframework-aws>=2.0.0,<3.0.0'],
 'cv': ['rpaframework-recognition>=3.0.0,<4.0.0'],
