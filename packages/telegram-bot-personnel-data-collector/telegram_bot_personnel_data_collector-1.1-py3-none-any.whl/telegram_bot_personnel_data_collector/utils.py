...
class YamlDataAbstract(dict, ABC):
    def __init__(self, yaml_file=None):
        ...
        assert self._yaml_file is not None, "Please provide Yaml file source"
        logging.info(f"Localisation loaded from: {self._yaml_file}")

    def load(self):
        data = load_yaml(self._yaml_file)
        logging.info(f"File {self._yaml_file} loaded")
