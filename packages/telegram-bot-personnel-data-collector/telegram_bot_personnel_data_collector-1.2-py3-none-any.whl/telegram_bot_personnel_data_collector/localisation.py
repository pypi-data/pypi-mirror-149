...
# from session_cache import UserSessionException
...
ServiceVocabulary: _vocabulary = _vocabulary(os.path.join('configuration', 'localisation.yaml'))
...
if __name__ == '__main__':
    ...
    prompt = "{}".format(ServiceVocabulary['welcome_banner']['text']['uk'])
    print(prompt)
