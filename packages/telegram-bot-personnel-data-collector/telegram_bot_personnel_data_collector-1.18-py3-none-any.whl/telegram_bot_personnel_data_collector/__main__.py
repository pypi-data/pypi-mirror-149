...
from telegram_bot_personnel_data_collector.telegram import Service, handlers_register
...
from telegram_bot_personnel_data_collector.utils import create_logger
...
def main(*callback_list):
    try:
        OpenSessions.start()
        DB_AS_GoogleSheet.init(table_url=os.getenv('TABLE_URL'),
        ...
        ServiceVocabulary.load(os.path.join(Configurations.PACKAGE_DIR, 'content', 'localisation.yaml'))
...
if __name__ == '__main__':
    ...
    if arguments.version:
        ...
        sys.exit(0)
    Configurations.PACKAGE_DIR = arguments.configuration
