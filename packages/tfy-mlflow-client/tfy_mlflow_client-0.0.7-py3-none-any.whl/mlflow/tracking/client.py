...
class MlflowClient:
    ...
    def list_run_logs(
        self, run_uuid: str, key: Optional[str] = None, log_type: Optional[str] = None
    ) -> List[RunLog]:
        return self._tracking_client.list_run_logs(run_uuid=run_uuid, key=key, log_type=log_type)
