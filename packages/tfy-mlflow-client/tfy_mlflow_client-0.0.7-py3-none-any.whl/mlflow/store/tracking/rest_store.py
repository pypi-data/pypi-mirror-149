...
class RestStore(AbstractStore):
    ...
    def list_run_logs(
        self, run_uuid: str, key: typing.Optional[str] = None, log_type: typing.Optional[str] = None
    ) -> typing.List[RunLog]:
        request_body_proto = ListRunLogs(run_uuid=run_uuid, key=key or "", log_type=log_type or "")
        request_body = message_to_json(request_body_proto)
