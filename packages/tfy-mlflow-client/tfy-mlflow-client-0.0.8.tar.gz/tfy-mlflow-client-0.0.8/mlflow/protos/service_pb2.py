...
_RUNINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fqn', full_name='mlflow.RunInfo.fqn', index=10,
...
_GETRUNBYFQN_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='mlflow.GetRunByFqn.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='run', full_name='mlflow.GetRunByFqn.Response.run', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETRUNBYFQN = _descriptor.Descriptor(
  name='GetRunByFqn',
  full_name='mlflow.GetRunByFqn',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='run_fqn', full_name='mlflow.GetRunByFqn.run_fqn', index=0,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_GETRUNBYFQN_RESPONSE, ],
  enum_types=[
  ],
  serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
  is_extendable=False,
...
_GETRUNBYFQN_RESPONSE.fields_by_name['run'].message_type = _RUN
_GETRUNBYFQN_RESPONSE.containing_type = _GETRUNBYFQN
...
DESCRIPTOR.message_types_by_name['GetRunByFqn'] = _GETRUNBYFQN
...
GetRunByFqn = _reflection.GeneratedProtocolMessageType('GetRunByFqn', (_message.Message,), dict(
...
_MLFLOWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='getRunByFqn',
    full_name='mlflow.MlflowService.getRunByFqn',
    index=20,
    containing_service=None,
    input_type=_GETRUNBYFQN,
    output_type=_GETRUNBYFQN_RESPONSE,
