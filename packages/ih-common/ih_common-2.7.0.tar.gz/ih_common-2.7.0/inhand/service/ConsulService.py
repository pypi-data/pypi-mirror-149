...
class ConsulService(object):
    ...
    def check(self,host, port, interval, timeout=None, deregister=None):
...
if __name__ == '__main__':
    ...
    consulService.registerService(name,service_id,ip,port,tags)

    check=consulService.check()
    print(check)
    res=consulService.getService(name)
    print(res)
