...
class Transform(google.protobuf.message.Message):
    ...
    class Spec(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["cast",b"cast","composed",b"composed","external",b"external","filter",b"filter","identity",b"identity","inverse_transcode",b"inverse_transcode","join",b"join","project",b"project","protect_dataset",b"protect_dataset","sample",b"sample","shuffle",b"shuffle","spec",b"spec","synthetic",b"synthetic","transcode",b"transcode","user_settings",b"user_settings","variable",b"variable"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["cast",b"cast","composed",b"composed","external",b"external","filter",b"filter","identity",b"identity","inverse_transcode",b"inverse_transcode","join",b"join","project",b"project","protect_dataset",b"protect_dataset","sample",b"sample","shuffle",b"shuffle","spec",b"spec","synthetic",b"synthetic","transcode",b"transcode","user_settings",b"user_settings","variable",b"variable"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["spec",b"spec"]) -> typing.Optional[typing_extensions.Literal["identity","variable","composed","project","filter","shuffle","join","cast","sample","user_settings","protect_dataset","external","synthetic","transcode","inverse_transcode"]]: ...
    ...
    class External(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["arguments",b"arguments","named_arguments",b"named_arguments","op",b"op"]) -> None: ...
    ...
    class Sample(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["fraction",b"fraction","proportion",b"proportion","size",b"size"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["fraction",b"fraction","proportion",b"proportion","size",b"size"]) -> None: ...
    ...
    class Protect(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["protected_entities",b"protected_entities","public_entities",b"public_entities"]) -> None: ...
    ...
    class Transcode(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["data_type",b"data_type","protected_path",b"protected_path","statistics",b"statistics"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["data_type",b"data_type","protected_path",b"protected_path","statistics",b"statistics"]) -> None: ...
    ...
    class InverseTranscode(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["transcode",b"transcode"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["transcode",b"transcode"]) -> None: ...
