...
class Status(google.protobuf.message.Message):
    ...
    class Stage(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["error",b"error","pending",b"pending","processing",b"processing","ready",b"ready","stage",b"stage"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["stage",b"stage"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["dataset",b"dataset","datetime",b"datetime","manager",b"manager","properties",b"properties","stage",b"stage","task",b"task","uuid",b"uuid"]) -> None: ...
