...
class Statistics(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["array",b"array","boolean",b"boolean","bytes",b"bytes","constrained",b"constrained","datetime",b"datetime","enum",b"enum","float",b"float","id",b"id","integer",b"integer","list",b"list","null",b"null","optional",b"optional","statistics",b"statistics","struct",b"struct","text",b"text","union",b"union","unit",b"unit"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["array",b"array","boolean",b"boolean","bytes",b"bytes","constrained",b"constrained","datetime",b"datetime","enum",b"enum","float",b"float","id",b"id","integer",b"integer","list",b"list","name",b"name","null",b"null","optional",b"optional","properties",b"properties","statistics",b"statistics","struct",b"struct","text",b"text","union",b"union","unit",b"unit"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["statistics",b"statistics"]) -> typing.Optional[typing_extensions.Literal["null","unit","boolean","integer","enum","float","text","bytes","struct","union","optional","list","array","datetime","id","constrained"]]: ...
