...
def upper_lower_signal_envelopes(epoch: np.ndarray):
	"""

	Args:
		epoch: array of signals that has been segmented from a larger array -> A numpy ndarray

	Returns: Two numpy arrays that represent the upper and lower
	...
	# u_p = CubicSpline(u_x,u_y)
	# l_p = CubicSpline(l_x,l_y)
