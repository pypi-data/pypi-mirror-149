...
class DownloadTarget(NamedTuple):
    ...
    :param edition: Edition of mongo (e.g. enterprise).
    :param platform: Platform mongo was built for (e.g. ubuntu1804).
    :param architecture: CPU architecture mongo was built for (e.g. x86).
    """
