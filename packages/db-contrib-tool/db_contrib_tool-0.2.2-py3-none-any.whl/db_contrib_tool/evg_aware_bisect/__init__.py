...
class BisectPlugin(PluginInterface):
    ...
    def _add_args_to_parser(cls, parser):
        ...
        parser.add_argument(
            ...
            f"'python3' or '{cls.TOOLCHAIN_PYTHON3}' (if toolchain is setup) will be used.",
        )
        parser.add_argument(
            "-ec",
            "--evergreenConfig",
    ...
    def _update_args(cls, args):
        ...
        if os.path.isfile(cls.TOOLCHAIN_PYTHON3):
            args.python_installation = cls.TOOLCHAIN_PYTHON3
