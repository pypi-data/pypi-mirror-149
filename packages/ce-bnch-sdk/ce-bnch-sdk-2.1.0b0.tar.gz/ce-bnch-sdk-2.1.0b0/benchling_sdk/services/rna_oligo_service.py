...
from benchling_api_client.v2.alpha.api.rna_oligos import bulk_upsert_rna_oligos, upsert_rna_oligo
from benchling_api_client.v2.alpha.models.oligo_upsert_request import OligoUpsertRequest
from benchling_api_client.v2.alpha.models.rna_oligos_bulk_upsert_request import RnaOligosBulkUpsertRequest
...
class RnaOligoService(BaseService):
    ...
    def upsert(self, entity_registry_id: str, rna_oligo: OligoUpsertRequest) -> RnaOligo:
        ...
        response = upsert_rna_oligo.sync_detailed(
            client=alpha_client, entity_registry_id=entity_registry_id, json_body=rna_oligo
        )
        return model_from_detailed(response)
    ...
    def bulk_upsert(self, body: RnaOligosBulkUpsertRequest) -> AsyncTaskLink:
        ...
        """
        alpha_client = v2_alpha_client(self.client)
        response = bulk_upsert_rna_oligos.sync_detailed(client=alpha_client, json_body=body)
        return model_from_detailed(response)
