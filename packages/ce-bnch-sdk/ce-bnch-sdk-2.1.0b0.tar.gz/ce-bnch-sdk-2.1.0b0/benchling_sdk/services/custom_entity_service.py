...
from benchling_api_client.v2.alpha.api.custom_entities import (
    bulk_upsert_custom_entities,
    upsert_custom_entity,
)
from benchling_api_client.v2.alpha.models.custom_entities_bulk_upsert_request import (
    CustomEntitiesBulkUpsertRequest,
)
from benchling_api_client.v2.alpha.models.custom_entity_upsert_request import CustomEntityUpsertRequest
...
class CustomEntityService(BaseService):
    ...
    def upsert(self, entity_registry_id: str, entity: CustomEntityUpsertRequest) -> CustomEntity:
        ...
        response = upsert_custom_entity.sync_detailed(
            client=alpha_client, entity_registry_id=entity_registry_id, json_body=entity
        )
        return model_from_detailed(response)
    ...
    def bulk_upsert(self, body: CustomEntitiesBulkUpsertRequest) -> AsyncTaskLink:
        ...
        """
        alpha_client = v2_alpha_client(self.client)
        response = bulk_upsert_custom_entities.sync_detailed(client=alpha_client, json_body=body)
        return model_from_detailed(response)
