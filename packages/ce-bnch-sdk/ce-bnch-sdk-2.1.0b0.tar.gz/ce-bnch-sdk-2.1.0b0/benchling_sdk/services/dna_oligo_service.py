...
from benchling_api_client.v2.alpha.api.dna_oligos import bulk_upsert_dna_oligos, upsert_dna_oligo
from benchling_api_client.v2.alpha.models.dna_oligos_bulk_upsert_request import DnaOligosBulkUpsertRequest
from benchling_api_client.v2.alpha.models.oligo_upsert_request import OligoUpsertRequest
...
class DnaOligoService(BaseService):
    ...
    def upsert(self, entity_registry_id: str, dna_oligo: OligoUpsertRequest) -> DnaOligo:
        ...
        response = upsert_dna_oligo.sync_detailed(
            client=alpha_client, entity_registry_id=entity_registry_id, json_body=dna_oligo
        )
        return model_from_detailed(response)
    ...
    def bulk_upsert(self, body: DnaOligosBulkUpsertRequest) -> AsyncTaskLink:
        ...
        """
        alpha_client = v2_alpha_client(self.client)
        response = bulk_upsert_dna_oligos.sync_detailed(client=alpha_client, json_body=body)
        return model_from_detailed(response)
