...
async def authorize_user_service(request: web.Request) -> web.Response:
    unauthorized_message = (
        "Unauthorized. If viewing in a web browser, please first visit the FastAPI documentation link in the "
        "Anyscale serve deployments page to authorize. Otherwise, please include the cluster's `user_service_token` "
        "in the Authorization bearer headers of the request."
    )
