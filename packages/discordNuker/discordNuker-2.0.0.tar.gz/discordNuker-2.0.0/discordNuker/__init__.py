...
def createChan(guild_id, amount: int=1, channel_name, type_c, bot_token):
    if type_c == 'voice':
...
def createRole(guild_id, amount: int=1, role_name, type_c, bot_tokens):
...
def sendMeassges(channel_id, amount: int=10, message, bot_token):
