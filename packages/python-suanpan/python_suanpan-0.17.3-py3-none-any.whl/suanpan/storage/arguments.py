...
csv = lazy_import.lazy_module("suanpan.utils.csv")
excel = lazy_import.lazy_module("suanpan.utils.excel")
image = lazy_import.lazy_module("suanpan.utils.image")
json = lazy_import.lazy_module("suanpan.utils.json")
npy = lazy_import.lazy_module("suanpan.utils.npy")
