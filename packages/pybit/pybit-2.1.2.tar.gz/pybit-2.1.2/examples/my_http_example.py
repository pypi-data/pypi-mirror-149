...
# Unauthenticated
session_unauth = usdt_perpetual.HTTP(record_request_time=False,
                                      api_key=api_key,
...
#x = session_unauth.latest_information_for_symbol(symbol="EOSUSD")
#print(type(x[1]))
#print(x[1])
print(session_unauth.extended_user_trade_records(
    symbol="BTCUSDT"
))
