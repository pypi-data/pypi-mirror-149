...
from .functions_time import from_local_time_to_utc
...
def retrieve_multiple_telemetries(user,
    ...
    from_UTC_time = from_local_time_to_utc(datetime.fromisoformat(from_local_time).replace(microsecond=0).isoformat(),
                                           tz_code)
    to_UTC_time = from_local_time_to_utc(datetime.fromisoformat(to_local_time).replace(microsecond=0).isoformat(),
                                         tz_code)
