...
def shap_explainer(reg, df, lista_colonne_x, colonna_y):
    import shap
    import numpy as np
    import pandas as pd
    import matplotlib.pyplot as plt
    ...
    shap.dependence_plot("x", shap_values, X, plot_type="bar")
    shap.dependence_plot("x", shap_values, X, plot_type="dot")
    shap.dependence_plot("x", shap_values, X, plot_type="violin")
