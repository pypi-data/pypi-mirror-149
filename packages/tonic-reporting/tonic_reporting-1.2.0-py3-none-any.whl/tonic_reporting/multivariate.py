...
def summarize_correlations(
    ...
    real_data, synth_data = filter_null_and_match_row_counts(real_data, synth_data, numeric_columns)
...
def plot_correlations(
    ...
    real_data, synth_data = filter_null_and_match_row_counts(real_data, synth_data, columns)
