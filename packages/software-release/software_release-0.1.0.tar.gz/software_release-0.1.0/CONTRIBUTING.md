...
Report bugs at [https://github.com/boromir674/software-release/issues](https://github.com/boromir674/software-release/issues).
W
Stambling upon a Bug means encountering different behaviour than the expected/advertised one. When you are reporting a bug, please include the following infromation by filling in [the template](https://github.com/boromir674/software-release/.github/blob/master/.github/ISSUE_TEMPLATE/bug_report.md).
...
Software Release could always use more documentation, whether as part of the official Software Release docs, in docstrings, etc.
...
The best way to send feedback is to file an issue at [https://github.com/boromir674/software-release/issues](https://github.com/boromir674/software-release/issues).
...
Here's how to set up `software-release` for local development.

1. Fork the `software-release` repo on GitHub.
2. Clone your fork locally:

```bash
git clone git@github.com:boromir674/software-release.git
cd software-release
```
...
Software Release is designed to do one thing, and do that one thing very well.
...
The roadmap located [here](https://github.com/boromir674/software-release/milestones?direction=desc&sort=due_date&state=open)
