...
filepath = input('Enter file path containing RLNEK_tests folder. Example (for Windows): Users/name/Documents/GitHub/RLNEK: ')
os.chdir('/%s/RLNEK_tests/Module_0B_test' % filepath)
# %%
