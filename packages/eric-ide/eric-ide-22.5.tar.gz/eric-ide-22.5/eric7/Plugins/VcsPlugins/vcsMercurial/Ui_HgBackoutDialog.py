# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.5/eric/eric7/Plugins/VcsPlugins/vcsMercurial/HgBackoutDialog.ui'
#
...
class Ui_HgBackoutDialog(object):
    def setupUi(self, HgBackoutDialog):
        ...
        self.expressionButton = QtWidgets.QRadioButton(self.revisionGroup)
        self.expressionButton.setObjectName("expressionButton")
        self.gridLayout.addWidget(self.expressionButton, 5, 0, 1, 1)
        self.expressionEdit = QtWidgets.QLineEdit(self.revisionGroup)
