# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.5/eric/eric7/Plugins/VcsPlugins/vcsMercurial/RebaseExtension/HgRebaseDialog.ui'
#
...
class Ui_HgRebaseDialog(object):
    def setupUi(self, HgRebaseDialog):
        ...
        self.expression1Button = QtWidgets.QRadioButton(self.rev1GroupBox)
        self.expression1Button.setObjectName("expression1Button")
        self.gridLayout.addWidget(self.expression1Button, 5, 0, 1, 1)
        self.expression1Edit = QtWidgets.QLineEdit(self.rev1GroupBox)
        ...
        self.expression2Button = QtWidgets.QRadioButton(self.rev2GroupBox)
        self.expression2Button.setObjectName("expression2Button")
        self.gridLayout_2.addWidget(self.expression2Button, 5, 0, 1, 1)
        self.expression2Edit = QtWidgets.QLineEdit(self.rev2GroupBox)
