def get_rules() :
    InferenceRules = dict(
        ...
        ?class owl:onProperty ?datatypeProperty ;
...
Property_Domain = [ "Property_Domain_One" , "Property_Domain_Two" , "Property_Domain_Three" ]
Property_Range = [ "Property_Range_One" , "Property_Range_Two" , "Property_Range_Three" ]
Object_Property_Inclusion = [ "Object_Property_Inclusion_One" , "Object_Property_Inclusion_Two" ] 
Data_Property_Inclusion = [ "Data_Property_Inclusion_One" , "Data_Property_Inclusion_Two" ]
Class_Equivalence = [ "Class_Equivalence_One" , "Class_Equivalence_Two" , "Class_Equivalence_Three" , "Class_Equivalence_Four" ]
Object_Property_Equivalence = [ "Object_Property_Equivalence_One" , "Object_Property_Equivalence_Two" , "Object_Property_Equivalence_Three" , "Object_Property_Equivalence_Four" ]
Data_Property_Equivalence = [ "Data_Property_Equivalence_One" , "Data_Property_Equivalence_Two" , "Data_Property_Equivalence_Three" , "Data_Property_Equivalence_Four" ]
Object_Property_Inversion = [ "Object_Property_Inversion_One" , "Object_Property_Inversion_Two" ]
Object_Some_Values_From = [ "Object_Some_Values_From_One" , "Object_Some_Values_From_Two" , "Object_Some_Values_From_Three" ]
Object_Has_Value = [ "Object_Has_Value_One" , "Object_Has_Value_Two" ]
Object_One_Of = [ "Object_One_Of_Membership" , "Object_One_Of_Inconsistency" ]
Object_All_Values_From = [ "Object_All_Values_From_One" , "Object_All_Values_From_Two" , "Object_All_Values_From_Three" ]
Object_Max_Cardinality = [ "Object_Max_Cardinality_One" , "Object_Max_Cardinality_Two" , "Object_Max_Cardinality_Three" ]
Object_Max_Qualified_Cardinality = [ "Object_Max_Qualified_Cardinality_One" , "Object_Max_Qualified_Cardinality_Two" , "Object_Max_Qualified_Cardinality_Three" , "Object_Max_Qualified_Cardinality_Four" , "Object_Max_Qualified_Cardinality_Five" ]
Object_Union_Of = [ "Object_Union_Of_One" , "Object_Union_Of_Two" ]
Object_Intersection_Of = [ "Object_Intersection_Of_One" , "Object_Intersection_Of_Two" , "Object_Intersection_Of_Three" ]
