...
def add_data_store_descriptor(
    ...
    :param str name: Name for new datastore. Name must be unique. \=\> \[a\-zA\-Z0\-9\_\\\-\\.\]\*
...
def update_data_store_descriptor(
    ...
    :param str dataStore: Store name
    :param str name: If set\, request datastore to change name. All entries will be updated \(so may take long time for large stores\). \=\> \[a\-zA\-Z0\-9\_\\\-\\.\]\*
