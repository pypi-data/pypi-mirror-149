...
def get_host_asset(
    id: str,
    includeVulnerabilies: bool = True,
    ...
    :param str id: HostAsset ID
    :param bool includeVulnerabilies: If false\, do not include vulnerabilities output. Defaults to true
    ...
    route = "/assets/v1/host/{id}".format(includeVulnerabilies=includeVulnerabilies,
    ...
    query_parameters = {}
    # Only send includeVulnerabilies if the argument was provided, dont send null values
    if includeVulnerabilies is not None:
        query_parameters.update({"includeVulnerabilies": includeVulnerabilies})
