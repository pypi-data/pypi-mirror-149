...
def add_annotation_filter(
    ...
    :param str triggerCode: The code which triggers the filter
    :param str statementCode: The code which will run then the filter is triggered
    :param str stage: The analysis stage the filter is run in \(default all\)
...
def update_annotation_filter(
    ...
    :param str triggerCode: The code which triggers the filter
    :param str statementCode: The code which will run then the filter is triggered
    :param str stage: The analysis stage the filter is run in
