...
def add_analysis_filter(
    ...
    :param str preStatementCode1: Optional esper code which does a pre selection before the statement code is run
    :param str preStatementCode2: Optional esper code to do further pre selection on the result of preStatementCode1\, and applied before the statementCode
    :param str statementCode: Esper code to select which events the filter will be applied to
    :param str triggerCode: Groovy code which is run on the selected events
    :param str actionName: The name of the signature which should be attached to the created event
    ...
    :param bool defaultAggregate: If true this filter will populate the created event with information from the selected event \(default false\)
    :param bool skipNewEvent: If true the filter will not submit triggered events for central storage \(default false\)
...
def update_analysis_filter(
    ...
    :param str triggerCode: Groovy code which is run on the selected events
    :param str actionName: The name of the signature which should be attached to the created event
    :param bool defaultAggregate: If true this filter will populate the created event with information from the selected event
    :param bool skipNewEvent: If true the filter will not submit triggered events for central storage
