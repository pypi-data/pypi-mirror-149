...
def add_match_filter(
    ...
    :param str matchCode: Custom esper code for when the filter should match an event. Will be validated in the backend
    :param str minSeverity: Only match events with severity at least this value
    :param str maxSeverity: Only match events with severity this value or lower
    :param list includeEventFlags: Only match events that have these flags
    :param list excludeEventFlags: Only match events that does not have any of these flags
    :param str protocol: Only match events with the provided protocol
    :param str domainPattern: Only match events where the domain matches this regex
    :param str uriPattern: Only match events where the uri matches this regex
    :param list sourceIPAddresses: Only match events where the source ip address is in this set. This corresponds to intruder in the old solution
    :param list sourcePorts: Only match events where the source port is in this set. This corresponds to intruder in the old solution
    :param list destinationIPAddresses: Only match events where the destination ip address is in this set. This corresponds to victim in the old solution
    :param list destinationPorts: Only match events where the destination port is in this set. This corresponds to victim in the old solution
    :param list sourceOrDestinationIPAddresses: Only match events where an ip address is in this set. This corresponds to intruderOrVictim in the old solution
    :param list sourceOrDestinationPorts: Only match events where a port is in this set. This corresponds to intruderOrVictim in the old solution
    :param list location: Only match events from the these locations\, given by shortname or id
    :param list attackIdentifier: Only match events with these attack identifiers\, given by shortname or id
    :param list alarmID: Only match events connected to these alarms\, given by id
    :param list attackCategory: Only match events belonging to these attack categories\, given by shortname or id
    :param list sensorID: Only match events from these sensors\, given by id
    :param dict properties: Only match events which have these properties
    :param str transformCode: Custom esper code for how the event will be transformed. Will be validated in the backend
    :param str newAggregationKey: If set this will set a new aggregation key on the event\, given that changeAggregationKey is set to true
    :param str newSeverity: The new severity of events that are matched by the filter
    :param int associatedCaseID: Adds an associated case ID
    :param int newSourceAggregationBits: Changes the aggregation bits of the source ip to this value. Source corresponds to what was earlier called intruder
    :param int newDestinationAggregationBits: Changes the aggregation bits of the destination ip to this value. Destination corresponds to what was earlier called victim
    ...
    :param bool drop: If true\, this event will be dropped \(default false\)
    :param bool noTransform: If true\, this event will not be transformed \(default false\)
    :param bool continueAfterTransform: If true\, this filter will continue to look for new events after transform \(default false\)
    :param bool stopAfterNoMatch: If true\, this filter will stop looking for new matches after not matching \(default false\)
    :param bool changeAggregationKey: If true\, this filter will change the aggregation key to the value of newAggregationKey \(default false\)
    :param bool invertIp: If true\, this filter will switch the source and destination ip in the event \(default false\)
...
def update_match_filter(
    ...
    :param int newSourceAggregationBits: Changes the aggregation bits of the source ip to this value. Source corresponds to what was earlier called intruder
    :param int newDestinationAggregationBits: Changes the aggregation bits of the destination ip to this value. Destination corresponds to what was earlier called victim
    :param bool drop: If true\, this event will be dropped
    :param bool noTransform: If true\, this event will not be transformed
    :param bool continueAfterTransform: If true\, this filter will continue to look for new events after transform
    :param bool stopAfterNoMatch: If true\, this filter will stop looking for new matches after not matching
    :param bool changeAggregationKey: If true\, this filter will change the aggregation key to the value of newAggregationKey
    :param bool invertIp: If true\, this filter will switch the source and destination ip in the event
