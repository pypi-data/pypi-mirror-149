import time, pyperclip, os, darkdetect, threading
...
class Kivy4(MDApp):
    ...
    def __init__(self, string: str = '', app_name: str = '', dict_of_files: dict = None,
        ...
        self.builder_string = '''<ContentKivy4>
    ...
    height: "100dp"'''
        ...
        self.dialog = None
        self.setProperties(main_color, icon, toolbar, string, pre_string)
    ...
    def setProperties(self, main_color, icon, toolbar, string, pre_string):
    ...
    def getToolbar(self, properties: list):
        ...
        self.left_icons = StringProperty(left_icons)
        self.right_icons = StringProperty(right_icons)
...
Screen:
    MDToolbar:
        ...
        elevation: 10
        title: "{name}"
        right_action_items: {self.left_icons}
        left_action_items: {self.right_icons}
...
'''
    ...
    def popup_kivy4(self, title='My popup', content=ContentKivy4(), cancel_text='CANCEL', okay_text='OKAY',
    ...
    def updateToolbar(self, lst):
        self.left_icons, self.right_icons = lst