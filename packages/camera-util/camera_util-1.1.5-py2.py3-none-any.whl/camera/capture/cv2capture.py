...
# Urs Utzinger
# 
# 2022 Added access to more opencv camera properties, auto populate missing configs
...
class cv2Capture(Thread):
    ...
    def resolution(self, val):
        ...
        if self.cam_open:
            ...
            if not self.log.full(): self.log.put_nowait((logging.ERROR, "CV2:Resolution:{}x{}".format(self._camera_res[0],self._camera_res[1])))
