...
def SimpleConsoleMenuBlock(menuName,menuItems,inputQuestion,autoAddQuit = False,onlyReturnNumber = True, allowedCharacters = '', acceptedQuitCharacters = ''):
    """
    ...
    for x in menuItemsList:
        ...
        print(f'│{menuItemsWithNumbers}'+(74-len(menuItemsWithNumbers))*' '+'│')
        menuNumber += 1
    print('╰'+74*'─'+'╯')
    while chooseLoop:
        choose = input(inputQuestion)
...
print(SimpleConsoleMenuBlock('menu','item1;item2;item3;item4;item5','Number:',True,True))
