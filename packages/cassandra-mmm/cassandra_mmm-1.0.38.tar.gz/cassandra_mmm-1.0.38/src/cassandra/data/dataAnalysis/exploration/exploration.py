...
from cassandra.data.dataAnalysis.exploration.utils import show_media, show_no_media, create_df, define_features
...
def exploration(csv, name_date_column, name_target_column, dict_columns_aggregate={}, window_start='',
                ...
                min_periods_corr=1, plot_for_line=5, show_only_one='',
                constant_ols=True):
    # create csv
    ...
    display(new_df.corr(method=method_corr, min_periods=min_periods_corr))
