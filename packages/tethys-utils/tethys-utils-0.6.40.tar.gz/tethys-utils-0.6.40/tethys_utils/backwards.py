...
def copy_old_dataset_to_new(source_remote, dest_remote, dataset, version_data, temp_path, remove_station_id=True, max_workers=4):
    """
    ...
    stn_paths = titan.update_stations(new_paths11, threads=80, max_workers=max_workers)
