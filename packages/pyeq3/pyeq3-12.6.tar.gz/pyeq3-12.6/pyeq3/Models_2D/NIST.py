...
class NIST_Bennett5(pyeq3.Model_2D_BaseClass.Model_2D_BaseClass):
...
class NIST_BoxBOD(pyeq3.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def CalculateModelPredictions(self, inCoeffs, inDataCacheDictionary):
        # only need to perform this dictionary look-up once
        x_in = inDataCacheDictionary['NegX']
...
class NIST_Chwirut(pyeq3.Model_2D_BaseClass.Model_2D_BaseClass):
...
class NIST_ENSO(pyeq3.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def GetDataCacheFunctions(self):
        functionList = []
        functionList.append(
            [pyeq3.DataCache.DataCacheFunctions.NistEnsoCosX(NameOrValueFlag=1), []])
        functionList.append(
            [pyeq3.DataCache.DataCacheFunctions.NistEnsoSinX(NameOrValueFlag=1), []])
        functionList.append(
            [pyeq3.DataCache.DataCacheFunctions.TwoPiX(NameOrValueFlag=1), []])
        return self.extendedVersionHandler.GetAdditionalDataCacheFunctions(self, functionList)

    def CalculateModelPredictions(self, inCoeffs, inDataCacheDictionary):
        # only need to perform this dictionary look-up once
        x_NistEnsoCosX = inDataCacheDictionary['NistEnsoCosX']
        # only need to perform this dictionary look-up once
        x_NistEnsoSinX = inDataCacheDictionary['NistEnsoSinX']
        # only need to perform this dictionary look-up once
        x_TwoPiX = inDataCacheDictionary['TwoPiX']
...
class NIST_Eckerle4(pyeq3.Model_2D_BaseClass.Model_2D_BaseClass):
...
class NIST_Gauss(pyeq3.Model_2D_BaseClass.Model_2D_BaseClass):
...
class NIST_Hahn(pyeq3.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def CalculateModelPredictions(self, inCoeffs, inDataCacheDictionary):
        ...
        try:
            temp = (a + b * x_in + c * x_PowX2 + d * x_PowX3) / \
                (1.0 + f * x_in + g * x_PowX2 + h * x_PowX3)
            return self.extendedVersionHandler.GetAdditionalModelPredictions(temp, inCoeffs, inDataCacheDictionary, self)
        except:
            return numpy.ones(len(inDataCacheDictionary['DependentData'])) * 1.0E300
...
class NIST_Kirby(pyeq3.Model_2D_BaseClass.Model_2D_BaseClass):
...
class NIST_Lanczos(pyeq3.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def CalculateModelPredictions(self, inCoeffs, inDataCacheDictionary):
        ...
        try:
            temp = a * numpy.exp(b * x_NegX) + c * \
                numpy.exp(d * x_NegX) + f * numpy.exp(g * x_NegX)
            return self.extendedVersionHandler.GetAdditionalModelPredictions(temp, inCoeffs, inDataCacheDictionary, self)
        except:
            return numpy.ones(len(inDataCacheDictionary['DependentData'])) * 1.0E300
...
class NIST_MGH09(pyeq3.Model_2D_BaseClass.Model_2D_BaseClass):
...
class NIST_MGH10(pyeq3.Model_2D_BaseClass.Model_2D_BaseClass):
...
class NIST_MGH17(pyeq3.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def CalculateModelPredictions(self, inCoeffs, inDataCacheDictionary):
        # only need to perform this dictionary look-up once
        x_Neg = inDataCacheDictionary['NegX']
...
class NIST_Rat42(pyeq3.Model_2D_BaseClass.Model_2D_BaseClass):
...
class NIST_Rat43(pyeq3.Model_2D_BaseClass.Model_2D_BaseClass):
...
class NIST_Roszman(pyeq3.Model_2D_BaseClass.Model_2D_BaseClass):
...
class NIST_Thurber(pyeq3.Model_2D_BaseClass.Model_2D_BaseClass):
