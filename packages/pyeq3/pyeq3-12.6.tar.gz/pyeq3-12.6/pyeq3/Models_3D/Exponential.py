...
class FullCubicExponential(pyeq3.Model_3D_BaseClass.Model_3D_BaseClass):
    ...
    def GetDataCacheFunctions(self):
        ...
        functionList.append([pyeq3.DataCache.DataCacheFunctions.PowExpX(
            NameOrValueFlag=1, args=[2.0]), [2.0]])
        functionList.append([pyeq3.DataCache.DataCacheFunctions.PowExpY(
            NameOrValueFlag=1, args=[2.0]), [2.0]])
        functionList.append([pyeq3.DataCache.DataCacheFunctions.PowExpX(
        ...
        functionList.append([pyeq3.DataCache.DataCacheFunctions.PowExpX_PowExpY(
    ...
    def CalculateModelPredictions(self, inCoeffs, inDataCacheDictionary):
        ...
        # only need to perform this dictionary look-up once
        PowExpX_2 = inDataCacheDictionary['PowExpX_2.0']
        # only need to perform this dictionary look-up once
        PowExpY_2 = inDataCacheDictionary['PowExpY_2.0']
        # only need to perform this dictionary look-up once
        PowExpX_3 = inDataCacheDictionary['PowExpX_3.0']
        # only need to perform this dictionary look-up once
        PowExpY_3 = inDataCacheDictionary['PowExpY_3.0']
        # only need to perform this dictionary look-up once
        ExpX_ExpY = inDataCacheDictionary['ExpX_ExpY']
        # only need to perform this dictionary look-up once
        PowExpX_PowExpY_21 = inDataCacheDictionary['PowExpX_PowExpY_2.01.0']
        # only need to perform this dictionary look-up once
        PowExpX_PowExpY_12 = inDataCacheDictionary['PowExpX_PowExpY_1.02.0']
...
class FullCubicExponentialTransform(pyeq3.Model_3D_BaseClass.Model_3D_BaseClass):
    ...
    def CalculateModelPredictions(self, inCoeffs, inDataCacheDictionary):
        ...
        try:
            ...
            temp += j * numpy.square(numpy.exp(m * x_in + n)
                                     ) * numpy.exp(o * y_in + p)
            temp += k * numpy.exp(m * x_in + n) * \
                numpy.square(numpy.exp(o * y_in + p))
            return self.extendedVersionHandler.GetAdditionalModelPredictions(temp, inCoeffs, inDataCacheDictionary, self)
        except:
            return numpy.ones(len(inDataCacheDictionary['DependentData'])) * 1.0E300
...
class FullQuadraticExponential(pyeq3.Model_3D_BaseClass.Model_3D_BaseClass):
    ...
    def CalculateModelPredictions(self, inCoeffs, inDataCacheDictionary):
        ...
        ExpY = inDataCacheDictionary['ExpY']
        # only need to perform this dictionary look-up once
        PowExpX2 = inDataCacheDictionary['PowExpX_2.0']
        # only need to perform this dictionary look-up once
        PowExpY2 = inDataCacheDictionary['PowExpY_2.0']
        # only need to perform this dictionary look-up once
        ExpX_ExpY = inDataCacheDictionary['ExpX_ExpY']
...
class LinearExponentialTransform(pyeq3.Model_3D_BaseClass.Model_3D_BaseClass):
    ...
    def CalculateModelPredictions(self, inCoeffs, inDataCacheDictionary):
        ...
        try:
            temp = a + b * numpy.exp(d * x_in + f) + \
                c * numpy.exp(g * y_in + h)
            return self.extendedVersionHandler.GetAdditionalModelPredictions(temp, inCoeffs, inDataCacheDictionary, self)
        except:
            return numpy.ones(len(inDataCacheDictionary['DependentData'])) * 1.0E300
...
class SimplifiedCubicExponential(pyeq3.Model_3D_BaseClass.Model_3D_BaseClass):
    ...
    def CalculateModelPredictions(self, inCoeffs, inDataCacheDictionary):
        ...
        PowExpY2 = inDataCacheDictionary['PowExpY_2.0']
        # only need to perform this dictionary look-up once
        PowExpX3 = inDataCacheDictionary['PowExpX_3.0']
        # only need to perform this dictionary look-up once
        PowExpY3 = inDataCacheDictionary['PowExpY_3.0']
...
class SimplifiedQuadraticExponentialTransform(pyeq3.Model_3D_BaseClass.Model_3D_BaseClass):
