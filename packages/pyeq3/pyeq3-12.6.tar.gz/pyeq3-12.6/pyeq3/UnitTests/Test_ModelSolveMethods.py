...
class TestModelSolveMethods(unittest.TestCase):
    ...
    def test_UserDefinedFunctionSolve_3D(self):
        ...
        self.assertTrue(numpy.allclose(
            result, resultShouldBe, rtol=1.0E-06, atol=1.0E-300))
    ...
    def test_SplineSolve_3D(self):
        resultShouldBe = (numpy.array([0.607, 0.607, 0.607, 3.017, 3.017, 3.017]),
                          ...
                          numpy.array([2.33418963, 1.80079612, 5.07902936, 0.54445029,
                                      1.04110843, 2.14180324, 0.26992805, 0.39148852, 0.8177307])
                          )
        ...
        result = model.Solve()
        self.assertTrue(numpy.allclose(
            result[0], resultShouldBe[0], rtol=1.0E-06, atol=1.0E-300))
        self.assertTrue(numpy.allclose(
            result[1], resultShouldBe[1], rtol=1.0E-06, atol=1.0E-300))
        self.assertTrue(numpy.allclose(
            result[2], resultShouldBe[2], rtol=1.0E-06, atol=1.0E-300))
