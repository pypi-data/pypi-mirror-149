...
class EpsilonDominance(Dominance):
    ...
    def same_box(self, solution1, solution2):
        ...
        for i in range(problem.nobjs):
            ...
            o1 = numpy.nan_to_num(o1, nan=numpy.inf)
            o1 = numpy.nan_to_num(o1)
            o2 = numpy.nan_to_num(o2, nan=numpy.inf)
            o2 = numpy.nan_to_num(o2)
            ...
            i1 = numpy.floor(o1 / epsilon)
            i2 = numpy.floor(o2 / epsilon)
