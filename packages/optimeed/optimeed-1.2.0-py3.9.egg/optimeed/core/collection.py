...
class Performance_ListDataStruct(ListDataStruct_Interface):
    ...
    def _get_json_str_at_index(self, index):
        ...
        if self.get_total_nbr_elements(count_unsaved=True) < index:
            ...
            json_str = linecache.getline(self._get_current_data_filename(self._mainfilename, filenumber), linenumber+1).strip()  # Open file and retrieve specific line
        return json_str

    def get_data_at_index(self, index, ignore_attributes=None):
        """
