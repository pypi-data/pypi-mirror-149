...
class On_click_export_to_txtfile(on_graph_click_interface):
    ...
    def __init__(self, theDataLink, attributes=None, attributes_shadow=None):
        """

        :param theDataLink: :class:`~optimeed.visualize.high_level.LinkDataGraph.LinkDataGraph`
        :param attributes: list of attributes (as string) to recover from the master (=displayed points)
