...
class SQLInsertRow(object):
    ...
    def __init__(self, table_info, schema, default_map, default_str_length):
...
class SQLInsertRows(object):
    ...
    def __init__(self, table_info, schema, default_map, str_size):
