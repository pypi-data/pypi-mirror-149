...
class BasicRouterOptions(object):
    ...
    session_timeout = property(_sql_router_sdk.BasicRouterOptions_session_timeout_get, _sql_router_sdk.BasicRouterOptions_session_timeout_set)
...
class SQLRouter(object):
    ...
    def ExecuteOfflineQuery(self, sql: "std::string const &", config: "std::map< std::string,std::string,std::less< std::string >,std::allocator< std::pair< std::string const,std::string > > > const &", default_db: "std::string const &", sync_job: "bool", job_info: "::openmldb::taskmanager::JobInfo &") -> "::openmldb::base::Status":
        return _sql_router_sdk.SQLRouter_ExecuteOfflineQuery(self, sql, config, default_db, sync_job, job_info)

    def ImportOnlineData(self, sql: "std::string const &", config: "std::map< std::string,std::string,std::less< std::string >,std::allocator< std::pair< std::string const,std::string > > > const &", default_db: "std::string const &", sync_job: "bool", job_info: "::openmldb::taskmanager::JobInfo &") -> "::openmldb::base::Status":
        return _sql_router_sdk.SQLRouter_ImportOnlineData(self, sql, config, default_db, sync_job, job_info)

    def ImportOfflineData(self, sql: "std::string const &", config: "std::map< std::string,std::string,std::less< std::string >,std::allocator< std::pair< std::string const,std::string > > > const &", default_db: "std::string const &", sync_job: "bool", job_info: "::openmldb::taskmanager::JobInfo &") -> "::openmldb::base::Status":
        return _sql_router_sdk.SQLRouter_ImportOfflineData(self, sql, config, default_db, sync_job, job_info)

    def ExportOfflineData(self, sql: "std::string const &", config: "std::map< std::string,std::string,std::less< std::string >,std::allocator< std::pair< std::string const,std::string > > > const &", default_db: "std::string const &", sync_job: "bool", job_info: "::openmldb::taskmanager::JobInfo &") -> "::openmldb::base::Status":
        return _sql_router_sdk.SQLRouter_ExportOfflineData(self, sql, config, default_db, sync_job, job_info)
