...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `verilog` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
}})();hljs.registerLanguage("php",e)})();/*! `tcl` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("tcl",e)})();/*! `objectivec` grammar compiled for Highlight.js 11.5.1 */
...
;hljs.registerLanguage("python-repl",a)})();/*! `scala` grammar compiled for Highlight.js 11.5.1 */
