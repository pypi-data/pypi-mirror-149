...
def train_model(actuators:list, model_name,model_version):
    ...
    for actuator in actuators:
        ...
        # Save model to disk
        try:
            os.makedirs(f'/data/model/{model_name_version}')
        except OSError as e:
            if e.errno != errno.EEXIST:
                raise
        filename = open(f"/data/model/{model_name_version}/{actuator}.pickle", "wb")
