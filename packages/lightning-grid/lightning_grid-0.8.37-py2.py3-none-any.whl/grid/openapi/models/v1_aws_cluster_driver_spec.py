...
class V1AWSClusterDriverSpec(object):
    ...
    def __init__(self, az_skip_ids: 'list[str]' = None, bastion_ami_override: 'str' = None, bucket_name: 'str' = None, builder_ami_name_override: 'str' = None, builder_ami_override: 'str' = None, builder_node_instance_type: 'str' = None, cpu_ami_override: 'str' = None, enable_dns_firewall: 'bool' = None, external_id: 'str' = None, gpu_ami_override: 'str' = None, guardduty_integration: 'bool' = None, instance_types: 'list[V1InstanceSpec]' = None, internal_gc_ttl: 'str' = None, internal_test_cluster: 'bool' = None, kubernetes_version: 'str' = None, management_node_instance_type: 'str' = None, original_cluster_name: 'str' = None, region: 'str' = None, role_arn: 'str' = None, tensorboard_node_instance_type: 'str' = None, x_multi_az_count: 'int' = None, _configuration=None):  # noqa: E501
