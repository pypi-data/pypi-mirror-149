...
class InterService(object):
    ...
    def run(self, pulsar_producer_topic, rabbitmq_send_exchange, rabbitmq_send_routing_key,
            ...
            rabbitmq_consumer_routing_key, pulsar_consumer_topic, pulsar_consumer_name, rabbitmq_task=None,
        ...
        pool.submit(self.pulsar_to_rabbitmq.run, pulsar_task, rabbitmq_send_exchange, rabbitmq_send_routing_key,
...
class InterServiceRB(object):
    ...
    def run(self, pulsar_producer_topic, rabbitmq_send_exchange, rabbitmq_send_routing_key,
        ...
        rb_service = self.rabbitmq_connect.consume_produce(rabbitmq_consumer_exchange, rabbitmq_consumer_routing_key,
                                                           rabbitmq_send_exchange, rabbitmq_send_routing_key,
...
class InterServicePS(object):
    ...
    def run(self, pulsar_consumer_topic, pulsar_consumer_name, rabbitmq_send_exchange, rabbitmq_send_routing_key,
            rabbitmq_consumer_exchange, rabbitmq_consumer_routing_key, pulsar_producer_topic=None, rabbitmq_task=None,
            pulsar_task=None, durable=False, consumer_durable=None, producer_durable=None, _async=True,
        ...
        :return:
        """
        rb_service = self.rabbitmq_connect.produce_consume(rabbitmq_consumer_exchange, rabbitmq_consumer_routing_key,
                                                           rabbitmq_send_exchange, rabbitmq_send_routing_key,
                                                           durable=durable, consumer_durable=consumer_durable,
                                                           producer_durable=producer_durable)
