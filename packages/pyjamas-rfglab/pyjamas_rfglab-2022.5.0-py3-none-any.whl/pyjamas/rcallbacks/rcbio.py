...
class RCBIO(RCallback):
    ...
    def cbLoadAnnotations(self, filenames: Optional[List[str]] = None, image_file: Optional[str] = None,
                          replace: bool = True) -> bool:  # Handle IO errors
        """
    ...
    def cbSaveTimeSeries(self, filename: Optional[str] = None) -> bool:
        '''
    ...
    def cbSaveROI(self, filename: Optional[str] = None, x_range: Tuple[int, int] = False,
                  y_range: Tuple[int, int] = False, z_range: Tuple[int, int] = False) -> bool:
        """
    ...
    def cbSaveDisplay(self, filename: Optional[str] = None) -> bool:
        """
    ...
    def cbExportMovie(self, filename: Optional[str] = None) -> bool:
        """
    ...
    def cbSaveAnnotations(self, filename: Optional[str] = None, polylines: Optional[List] = None,
                          fiducials: Optional[List] = None, pickle_protocol: int = DEFAULT_PICKLE_PROTOCOL) -> bool:  # Handle IO errors.
        """
    ...
    def cbExportAnnotationsXML(self, filename: Optional[str] = None) -> bool:
        """
    ...
    def cbExportCurrentAnnotationsBinaryImage(self, filename: Optional[str] = None,
                                              polyline: Optional[numpy.ndarray] = None) -> bool:
        """
    ...
    def cbSaveClassifier(self, filename: Optional[str] = None,
                         theclassifier: Optional[rimclassifier] = None) -> bool:  # Handle IO errors.
        """
    ...
    def cbLoadClassifier(self, filename: Optional[str] = None) -> bool:  # Handle IO errors
        """
    ...
    def cbExportAllPolylineAnnotations(self, folder_name: Optional[str] = None) -> bool:
        """
    ...
    def cbImportSIESTAAnnotations(self, filenames: Optional[List[str]] = None,
                                  image_file: Optional[str] = None, replace: bool = True) -> bool:
        """
    ...
    def cbExportSIESTAAnnotations(self, filename: Optional[str] = None) -> bool:
        """
