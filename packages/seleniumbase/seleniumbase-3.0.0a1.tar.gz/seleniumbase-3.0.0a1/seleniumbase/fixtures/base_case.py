...
class BaseCase(unittest.TestCase):
    ...
    def setUp(self, masterqa_mode=False):
        ...
        if self.is_pytest:
            ...
            if variables and type(variables) is str:
                import ast
                ...
                if (
                    ...
                    raise Exception(
                        ...
                        "\nEg. --variables=\"{'KEY':'VAL','KEY2':'VAL2'}\""
                    )
            ...
            self.__screenshot_count = 0  # Reset to prevent Dashboard log links
            self.__activate_virtual_display_as_needed()
    ...
    def __activate_post_mortem_debug_mode(self):
        ...
        if self.is_pytest:
            ...
            if hasattr(self, "is_behave") and self.is_behave and has_exception:
                if hasattr(sb_config, "pdb_option") and sb_config.pdb_option:
                    self.__enter_behave_post_mortem_debug_mode()
