...
class AnsibleGitRemote(object):
    ...
    def __init__(self, pulp_labels=None, rate_limit=None, client_key=None, username=None, download_concurrency=None, proxy_url=None, proxy_password=None, connect_timeout=None, name=None, ca_cert=None, tls_validation=None, sock_read_timeout=None, headers=None, total_timeout=None, url=None, proxy_username=None, password=None, max_retries=None, client_cert=None, sock_connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
