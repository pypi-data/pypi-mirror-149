...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_labels=None, rate_limit=None, download_concurrency=None, pulp_last_updated=None, proxy_url=None, connect_timeout=None, name=None, ca_cert=None, tls_validation=None, sock_read_timeout=None, headers=None, total_timeout=None, url=None, pulp_created=None, pulp_href=None, max_retries=None, client_cert=None, sock_connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
