...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, max_retries=None, proxy_password=None, proxy_url=None, rate_limit=None, total_timeout=None, download_concurrency=None, tls_validation=None, sock_read_timeout=None, pulp_labels=None, headers=None, connect_timeout=None, password=None, username=None, url=None, name=None, ca_cert=None, client_key=None, sock_connect_timeout=None, client_cert=None, proxy_username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
