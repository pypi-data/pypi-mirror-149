...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, url=None, sock_connect_timeout=None, pulp_href=None, name=None, connect_timeout=None, headers=None, tls_validation=None, rate_limit=None, proxy_url=None, pulp_last_updated=None, download_concurrency=None, ca_cert=None, pulp_labels=None, total_timeout=None, max_retries=None, client_cert=None, pulp_created=None, sock_read_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
