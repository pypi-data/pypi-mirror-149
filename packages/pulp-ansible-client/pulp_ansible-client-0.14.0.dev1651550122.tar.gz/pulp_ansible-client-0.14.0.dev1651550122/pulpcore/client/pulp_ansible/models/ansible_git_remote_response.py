...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, total_timeout=None, sock_connect_timeout=None, rate_limit=None, pulp_last_updated=None, client_cert=None, name=None, headers=None, url=None, proxy_url=None, pulp_created=None, download_concurrency=None, max_retries=None, pulp_href=None, connect_timeout=None, sock_read_timeout=None, pulp_labels=None, ca_cert=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
