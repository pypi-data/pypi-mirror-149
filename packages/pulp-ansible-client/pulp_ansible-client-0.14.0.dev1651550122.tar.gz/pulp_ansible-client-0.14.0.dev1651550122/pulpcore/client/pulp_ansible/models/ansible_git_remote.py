...
class AnsibleGitRemote(object):
    ...
    def __init__(self, total_timeout=None, password=None, sock_connect_timeout=None, rate_limit=None, proxy_username=None, username=None, client_cert=None, name=None, client_key=None, headers=None, url=None, proxy_url=None, download_concurrency=None, max_retries=None, connect_timeout=None, sock_read_timeout=None, pulp_labels=None, proxy_password=None, ca_cert=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
