...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, username=None, url=None, sock_connect_timeout=None, name=None, connect_timeout=None, headers=None, tls_validation=None, proxy_password=None, rate_limit=None, proxy_url=None, download_concurrency=None, ca_cert=None, pulp_labels=None, total_timeout=None, max_retries=None, client_cert=None, sock_read_timeout=None, client_key=None, proxy_username=None, password=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
