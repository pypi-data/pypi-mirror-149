...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, max_retries=None, pulp_created=None, pulp_href=None, proxy_url=None, rate_limit=None, total_timeout=None, download_concurrency=None, tls_validation=None, sock_read_timeout=None, pulp_labels=None, headers=None, connect_timeout=None, url=None, name=None, ca_cert=None, sock_connect_timeout=None, client_cert=None, pulp_last_updated=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
