...
class AnsibleGitRemote(object):
    ...
    def __init__(self, proxy_username=None, url=None, connect_timeout=None, sock_read_timeout=None, ca_cert=None, proxy_url=None, max_retries=None, name=None, sock_connect_timeout=None, password=None, client_cert=None, download_concurrency=None, tls_validation=None, username=None, rate_limit=None, proxy_password=None, client_key=None, total_timeout=None, headers=None, pulp_labels=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
