...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, url=None, connect_timeout=None, sock_read_timeout=None, ca_cert=None, proxy_url=None, max_retries=None, name=None, sock_connect_timeout=None, client_cert=None, download_concurrency=None, pulp_created=None, tls_validation=None, rate_limit=None, pulp_last_updated=None, total_timeout=None, headers=None, pulp_labels=None, pulp_href=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
