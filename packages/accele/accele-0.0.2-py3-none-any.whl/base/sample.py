...
from accele.dao import mysql_engine
from accele.fixture import *
...
fixture_login_content = """from accele.client import request
from accele.fixture import *
...
from accele.client import request
...
from accele.dao import print_db_table
...
test_request_content = """from accele.client import request
...
async def login(req: Request):
    body = await req.json()
    if body["username"] == "gri" and body["password"] == "123456":
...
import allure
from loguru import logger
from accele import client
from accele.client import TepResponse
...
def request(method, url, **kwargs):
    client.accele_request_monkey_patch = request_monkey_patch
...
test_login_pay_httprunner_content = """from httprunner import HttpRunner, Config, Saccele, RunRequest
    ...
    testsacceles = [
        Saccele(
            RunRequest("登录")
                ...
                .with_json({"username": "gri", "password": "123456"})
                .extract()
...
Login_content = """from accele.client import BaseRequest
...
SearchSku_content = """from accele.client import BaseRequest
...
AddCart_content = """from accele.client import BaseRequest
...
Order_content = """from accele.client import BaseRequest
...
Pay_content = """from accele.client import BaseRequest
...
test_login_pay_mvc_content = """from accele.fixture import TepVars
