   ...
   <head> 
        ...
        async function pywebcanvas(){
            ...
            pyodide.runPythonAsync(`
                ...
                await micropip.install("https://files.pythonhosted.org/packages/b3/90/2d3d33789461110ac411c3f1e2cb061c3aebaf34628e6f1a655766501cc0/pywebcanvas-0.1.12-py3-none-any.whl")
                import pywebcanvas as pwc
                # Your Code Here:
