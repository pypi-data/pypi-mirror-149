...
def main():
    ...
    parser.add_argument("-s", "--spacing", type = int, nargs = 1, default = 5, help = "Define spacing between the letter") 
    ...
    cli.SetVar(args.thickness[0],args.spacing[0],args.size[0],color,bgcolor,args.speed[0])
    userInput(Input)
