...
def get_allocation_stats():
    atxdp__udsv = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    ilbb__hnbc, xzd__kudom, eug__slmet, ufx__idt = 0, 0, 0, 0
    for mvr__njkha in atxdp__udsv:
        ilbb__hnbc += mvr__njkha[0]
        xzd__kudom += mvr__njkha[1]
        eug__slmet += mvr__njkha[2]
        ufx__idt += mvr__njkha[3]
    return ilbb__hnbc, xzd__kudom, eug__slmet, ufx__idt
