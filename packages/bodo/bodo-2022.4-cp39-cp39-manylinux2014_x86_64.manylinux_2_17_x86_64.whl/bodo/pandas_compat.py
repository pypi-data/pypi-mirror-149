...
if pandas_version < (1, 4):
    ...
    def _set_noconvert_columns(self):
        ...
        oqsct__rrw = {vrqt__kings: nsoa__upp for nsoa__upp, vrqt__kings in
            enumerate(self.orig_names)}
        sihe__jfz = [oqsct__rrw[vrqt__kings] for vrqt__kings in self.names]
        yxlba__vfwiz = self._set_noconvert_dtype_columns(sihe__jfz, self.names)
        for yzmvu__kvlar in yxlba__vfwiz:
            self._reader.set_noconvert(yzmvu__kvlar)
