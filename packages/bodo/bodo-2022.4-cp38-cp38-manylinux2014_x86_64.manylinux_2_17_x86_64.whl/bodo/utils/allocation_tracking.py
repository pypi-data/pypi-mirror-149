...
def get_allocation_stats():
    pjr__wid = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    jdfni__fvbh, kvbi__gvsxn, fte__jib, eltan__fofnp = 0, 0, 0, 0
    for naf__sbr in pjr__wid:
        jdfni__fvbh += naf__sbr[0]
        kvbi__gvsxn += naf__sbr[1]
        fte__jib += naf__sbr[2]
        eltan__fofnp += naf__sbr[3]
    return jdfni__fvbh, kvbi__gvsxn, fte__jib, eltan__fofnp
