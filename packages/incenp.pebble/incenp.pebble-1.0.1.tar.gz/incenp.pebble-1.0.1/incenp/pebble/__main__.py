...
# Copyright (C) 2018,2019,2020,2021,2022 Damien Goutte-Gattat
#
...
Copyright © 2018–2022 Damien Goutte-Gattat
...
@click.option('--only-password', '-p', is_flag=True, default=False,
