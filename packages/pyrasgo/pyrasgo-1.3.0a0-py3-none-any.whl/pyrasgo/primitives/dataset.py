...
class Dataset(Connection):
    ...
    #     """
    #     from pyrasgo.utils.dbt import dataset_to_model

    #     model = dataset_to_model(self)
    #     return model.save_file(models_directory=models_directory, config_args=config_args)
