...
class Publish:
    ...
    # ) -> str:
    #     """
    #     Exports a given dataset to a Model in a dbt Project

    #     Params:
    #     `dataset`: Rasgo Dataset
    #         dataset to write as a dbt model
    #     `models_directory`: Path:
    ...
    #     """
    #     return dataset.to_dbt(models_directory=Path(models_directory), config_args=config_args)
