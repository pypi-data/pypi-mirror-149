...
from django_api_proxy.adapters import StreamingHTTPAdapter
from django_api_proxy.settings import api_proxy_settings
from django_api_proxy.utils import StreamingMultipart, generate_boundary
    ...
    def get_default_headers(self, request):
        return {
            ...
            'Accept-Language': request.META.get('HTTP_ACCEPT_LANGUAGE',
                                                self.proxy_settings.DEFAULT_HTTP_ACCEPT_LANGUAGE),
