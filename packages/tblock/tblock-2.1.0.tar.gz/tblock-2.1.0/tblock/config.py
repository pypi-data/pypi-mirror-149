...
class Var:
    ...
    try:
        ...
        ALLOW_IPV6 = False
    REPO_MIRRORS = [
        "https://tblock.codeberg.page/repo/index.json",
        "https://codeberg.org/tblock/repo/raw/branch/pages/index.json",
        "https://framagit.org/twann/repo/-/raw/pages/index.json",
        "https://git.disroot.org/tblock/repo/raw/branch/pages/index.json",
        "https://0xacab.org/twann/repo/-/raw/pages/index.json",
        "http://wmj5kiic7b6kjplpbvwadnht2nh2qnkbnqtcv3dyvpqtz7ssbssftxid.onion/twann/repo/-/raw/pages/index.json"
    ]
