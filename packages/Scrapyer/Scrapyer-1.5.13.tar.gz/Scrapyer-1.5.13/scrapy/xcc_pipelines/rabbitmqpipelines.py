...
class RabbitMQPipeline(object):
    ...
    def from_crawler(cls, crawler):
        ...
        cfg_settings = {i:j for i ,j in get_config().items(section_select)}
        ...
        elif cfg_settings.get("rabbitmq_items_key"):
            item_key = cfg_settings.get("rabbitmq_items_key")
        else:
            item_key = 'items_{spider_name}'.format(
                spider_name=crawler.spider.name)
        return cls.from_settings(item_key,cfg_settings)
