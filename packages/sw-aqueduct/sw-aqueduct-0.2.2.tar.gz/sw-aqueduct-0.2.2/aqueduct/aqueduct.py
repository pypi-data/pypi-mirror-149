...
class Aqueduct(Base):
    ...
    DIFF_TEMPLATE = Template(f"The '$name' '$component' with the '$subcomponent' with value of $value would have been $type on the destination.")
    ...
    def sync(self, components=COMPONENTS, exclude: dict = {}, include: dict = {}):
        ...
        * roles
        ...
        if not Base.live:
            for item in Base._diff_log:
                print(self.DIFF_TEMPLATE.substitute(**item))
