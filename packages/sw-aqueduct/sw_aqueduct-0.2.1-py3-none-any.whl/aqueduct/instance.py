...
class SwimlaneInstance:
    ...
    def get_plugins(self):
        ...
        """
        return_list = []
        packages = self._make_request('GET', '/task/packages')
        if packages:
    ...
    def search_user(self, query_string: str):
        ...
        """
        try:
            resp = self._make_request('GET', f"/users/search?query={query_string}")
    ...
    def add_workflow(self, workflow):
        ...
        """
        try:
            return self._make_request('POST', f"/workflow/", json=workflow)
        except:
            return False
