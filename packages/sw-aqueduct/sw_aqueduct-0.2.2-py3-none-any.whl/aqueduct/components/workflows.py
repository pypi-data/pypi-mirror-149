        ...
        if workflow:
            ...
            if dest_workflow:
                ...
                if self.canonicalize(workflow['stages']) != self.canonicalize(dest_workflow['stages']):
                    ...
                    else: self.add_to_diff_log(f"{application_name} - Workflow", 'updated')
                else:
                ...
                else: self.add_to_diff_log(f"{application_name} - Workflow", 'added')
        else: raise GetComponentError(type='Workflow', name=application_name)
