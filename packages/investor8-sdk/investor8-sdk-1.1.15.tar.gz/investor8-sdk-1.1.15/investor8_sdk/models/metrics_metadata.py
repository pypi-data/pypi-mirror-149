...
class MetricsMetadata(object):
    ...
    def __init__(self, metric_name=None, display_name=None, description=None, unit=None, categories=None, data_format=None, display_format=None, last_modified=None, id=None):  # noqa: E501
