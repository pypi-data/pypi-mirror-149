...
function flushAudioElement() {
        /*
    flush audio element after coming back to page, digital noise problem
    */
    audio.volume = 0.25;
...
$(document).ready(function () {
    ...
    stationGet();
    streamerGet();
    setInterval(delete_info, 15005);
    setInterval(header_info, 10004);
