...
class TestPrivateSqlQuery:
    ...
    def test_worker_init_datasource(
        self, column_ranges: dict, datasource: DataSource
    ) -> None:
    ...
    def test_no_data(
        ...
        worker.datasource = Mock(spec=DataSource, data=None)
    ...
    def test_worker_gets_sql_results(
        self, column_ranges: dict, datasource: DataSource, pod_schema: BitfountSchema
    ) -> None:
