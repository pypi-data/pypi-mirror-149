...
from tests.utils.helper import backend_test, create_datasource, unit_test
...
class TestSqlQuery:
    ...
    def test_bad_sql_no_table(
        self, caplog: LogCaptureFixture, datasource: DataSource
    ) -> None:
    ...
    def test_sql_output_duplicate_cols_error(
        self, caplog: LogCaptureFixture, datasource: DataSource, mocker: MockerFixture
    ) -> None:
