...
from bitfount.federated.algorithms.model_algorithms.base import _BaseModelAlgorithm
...
class _Worker:
    ...
    async def _get_protocol(self) -> _BaseProtocolFactory:
        ...
        return cast(_BaseProtocolFactory, bf_load(serialized_protocol, _PROTOCOLS))
    ...
    def _load_data_for_worker(
        ...
        # This call loads the data for a multi-table DataSource as specified by the
