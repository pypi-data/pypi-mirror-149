...
from typing import Callable, Iterable, Iterator, Literal, Optional, Union, List, Tuple
...
class ExchangeCSVClient:
    ...
    def __init__(
        ...
        api_key: str,
        download_manager: Literal["async", "sync"] = "async",
    ):
    ...
    def generate_option_chain_snapshots(
        ...
        options_chain_iterator = self._iterate_time_range_data(
            from_datetime,
            to_datetime,
            snapshot_interval,
    ...
    def generate_derived_option_chain_snapshots(
        ...
        for _, end, dfs in combo_iterator:
            ...
            underlying_prices = {
                ...
                if len(underlying_df["price"])
                else underlying_prices[underlying]
