...
class PortMetrics(OpenApiObject):
    ...
    _TYPES = {
        ...
        'flow_counter_metrics': {'type': 'FlowCounterMetricsIter'},
    } # type: Dict[str, str]
    ...
    def flow_counter_metrics(self):
        # type: () -> FlowCounterMetricsIter
        """flow_counter_metrics getter

        TBD

        Returns: FlowCounterMetricsIter
        """
        return self._get_property('flow_counter_metrics', FlowCounterMetricsIter, self._parent, self._choice)
...
class FlowCounterMetricsIter(OpenApiIter):
    __slots__ = ('_parent', '_choice')

    _GETITEM_RETURNS_CHOICE_OBJECT = False

    def __init__(self, parent=None, choice=None):
        super(FlowCounterMetricsIter, self).__init__()
        self._parent = parent
        self._choice = choice

    def __getitem__(self, key):
        # type: (str) -> Union[FlowCounterMetrics]
        return self._getitem(key)
    ...
    def flowcountermetrics(self):
        # type: () -> FlowCounterMetricsIter
        """Factory method that creates an instance of the FlowCounterMetrics class

        TBD

        Returns: FlowCounterMetricsIter
        """
        item = FlowCounterMetrics(parent=self._parent)
        self._add(item)
        return self

    def add(self):
        # type: () -> FlowCounterMetrics
        """Add method that creates and returns an instance of the FlowCounterMetrics class
