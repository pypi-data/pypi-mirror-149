...
class AddContactDialog(PyQt5.QtWidgets.QDialog):
    ...
    def __init__(self, transport, database):
        ...
        self.selector_label = PyQt5.QtWidgets.QLabel(
            'Выберите контакт для добавления:', self)
        ...
        self.btn_refresh = PyQt5.QtWidgets.QPushButton('Обновить список', self)
        self.btn_refresh.setFixedSize(100, 30)
        self.btn_refresh.move(60, 60)

        self.btn_ok = PyQt5.QtWidgets.QPushButton('Добавить', self)
        self.btn_ok.setFixedSize(100, 30)
        self.btn_ok.move(230, 20)

        self.btn_cancel = PyQt5.QtWidgets.QPushButton('Отмена', self)
