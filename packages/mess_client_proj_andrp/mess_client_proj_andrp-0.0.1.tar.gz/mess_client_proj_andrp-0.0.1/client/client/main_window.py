...
class ClientMainWindow(QMainWindow):
    ...
    def add_contact_action(self, item):
        """
        Обработчик добавления, сообщает серверу, обновляет таблицу и
        список контактов
        :param item:
        :return:
        """
    ...
    def delete_contact(self, item):
        """
        Обработчик удаления контакта, сообщает на сервер, обновляет
        таблицу контактов
        :param item:
        :return:
        """
    ...
    def send_message(self):
        """
        Отправляет собщения пользователю.
        :return:
        """
