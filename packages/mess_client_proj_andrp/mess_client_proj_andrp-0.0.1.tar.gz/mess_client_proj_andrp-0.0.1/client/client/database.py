...
class ClientDatabase:
    ...
    def check_user(self, user):
        """
        Метод - проверяет наличие пользователя в известных
        :param user:
        :return:
        """
    ...
    def check_contact(self, contact):
        """
        Метод - проверяющяя наличие пользователя контактах
        :param contact:
        :return:
        """
...
if __name__ == '__main__':
    ...
    #test_db.save_message('test2', 'out', f'Привет! я другое тестовое сообщение
    # от {datetime.datetime.now()}!')
