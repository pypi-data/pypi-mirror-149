...
def to_message(testcase_id, is_correct):
    if is_correct:
        return f"Test case {testcase_id}: Passed ✓"
    return f"Test Case {testcase_id}: Failed ✗"
...
def grade_11(error_gradient):
    grade_11_helper("1.1.1", error_gradient, torch.Tensor([2.0, 3.0]), torch.Tensor([1.0, 1.0]))
    grade_11_helper("1.1.2", error_gradient, torch.Tensor([0.5, -1.0]), torch.Tensor([0.5, -1.0]))
    grade_11_helper("1.1.3", error_gradient, torch.Tensor([-1.5, 1.5]), torch.Tensor([0.0, 0.0]))
...
def grade_12(gradient_descent):
    grade_12_helper("1.2.1", gradient_descent, torch.Tensor([2.0, 3.0]), torch.Tensor([1.0, 1.0]))
    grade_12_helper("1.2.2", gradient_descent, torch.Tensor([0.5, -1.0]), torch.Tensor([0.5, -1.0]))
    grade_12_helper("1.2.3", gradient_descent, torch.Tensor([-1.5, 1.5]), torch.Tensor([0.0, 0.0]))
...
def grade_14(gradient_descent_with_logger):
    grade_14_helper("1.4.1", gradient_descent_with_logger, torch.Tensor([2.0, 3.0]), torch.Tensor([1.0, 1.0]))
    grade_14_helper("1.4.2", gradient_descent_with_logger, torch.Tensor([0.5, -1.0]), torch.Tensor([0.5, -1.0]))
    grade_14_helper("1.4.3", gradient_descent_with_logger, torch.Tensor([-1.5, 1.5]), torch.Tensor([0.0, 0.0]))
