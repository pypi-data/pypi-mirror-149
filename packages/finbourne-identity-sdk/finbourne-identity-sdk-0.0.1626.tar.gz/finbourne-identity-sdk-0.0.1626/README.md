...
- API version: 0.0.1626
- Package version: 0.0.1626
...
*MeApi* | [**set_password**](docs/MeApi.md#set_password) | **PUT** /api/me/password | [EXPERIMENTAL] SetPassword: Set password of current user
