...
def WorldParametersStart(builder): builder.StartObject(4)
...
def WorldParametersAddWeather(builder, weather): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(weather), 0)
