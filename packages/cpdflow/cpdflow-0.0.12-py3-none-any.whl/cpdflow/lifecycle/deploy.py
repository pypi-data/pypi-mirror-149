...
def deploy_remove(config: dict, model_configs: list[dict], space_type: str, backward_steps: list[str]) -> None:
    """
...
def deploy_update(config: dict, model_configs: list[dict], space_type: str) -> None:
    """
...
def deploy_create(config: dict, model_configs: list[dict], space_type: str, check_require_steps: list[str], forward_steps: list[str]) -> None:
    """
...
class deploy:
    ...
    @staticmethod
    def delete(config: dict, model_names: list[str], space_type: str) -> None:
        """
    ...
    @staticmethod
    def apply(config: dict, model_names: list[str], space_type: str) -> None:
        """
