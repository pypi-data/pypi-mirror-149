...
def subscribe_remove(config: dict, model_configs: list[dict], space_type: str, backward_steps: list[str]) -> None:
    """
...
def subscribe_overwrite(config: dict, model_configs: list[dict], space_type: str, backward_steps: list[str]) -> None:
    """
...
def subscribe_create(config: dict, model_configs: list[dict], space_type: str, scoring_payload: dict, feedback_payload: dict) -> None:
    """
...
def subscribe(config: dict, model_names: list[str], space_type: str) -> None:
    """
...
def evaluate(config: dict, model_names: list[str], space_type: str) -> None:
    """
...
class validate:
    ...
    @staticmethod
    def delete(config: dict, model_names: list[str]) -> None:
        """
    ...
    @staticmethod
    def apply(config: dict, model_names: list[str]) -> None:
        """
        Remove, overwrite or create subscriptions that are specified in ``model_configs``.
