...
def delete_model_by_model_names(config: dict, model_names: list[str], space_type: str, log_format: str) -> None:
    """
...
def delete_model_deployment_by_model_deployment_names(config: dict, model_deployment_names: list[str], space_type: str, log_format: str) -> None:
    """
...
def delete_function_by_function_names(config: dict, function_names: list[str], space_type: str, log_format: str) -> None:
    """
...
def delete_function_deployment_by_function_deployment_names(config: dict, function_deployment_names: list[str], space_type: str) -> None:
    """
