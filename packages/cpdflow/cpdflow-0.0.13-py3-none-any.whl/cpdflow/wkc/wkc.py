...
def delete_model_from_inventory_by_model_names(config: dict, model_names: list[str], space_type: str, log_format: str) -> None:
    """
...
def delete_model_from_project_inventory_by_model_names(config: dict, model_names: list[str], log_format: str):
    """
