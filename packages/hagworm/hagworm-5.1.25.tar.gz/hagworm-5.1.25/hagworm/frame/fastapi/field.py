...
def EnumValueType(enum):
    ...
    if enum not in _EnumValueTypeBase.__subclasses__:
        ...
        _EnumValueTypeBase.__subclasses__[enum] = type(
            f'EnumValueType_{enum.__name__}',
            (_EnumValueTypeBase,),
            {r'Enum': enum}
        )
...
class _EnumStrValueTypeBase(str):
...
def EnumStrValueType(enum):

    if enum not in _EnumStrValueTypeBase.__subclasses__:

        _EnumStrValueTypeBase.__subclasses__[enum] = type(
            f'EnumStrValueType_{enum.__name__}',
            (_EnumStrValueTypeBase,),
            {r'Enum': enum}
        )

    return _EnumStrValueTypeBase.__subclasses__.get(enum)
