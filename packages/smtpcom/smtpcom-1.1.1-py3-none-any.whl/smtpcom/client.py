...
class Response:
    ...
    def __init__(self, response: addinfourl) -> None:
        """
...
class Client(object):
    ...
    def __init__(
        ...
        url_path: typing.Optional[typing.List[str]] = None,
        append_slash: typing.Optional[bool] = False,
        timeout: typing.Optional[float] = None,
    ) -> None:
        """
        :param host: Base URL for the api. (e.g. https://api.smtp.com)
        :type host:  string
    ...
    def _build_versioned_url(self, url: str) -> str:
    ...
    def _update_headers(self, request_headers: dict) -> None:
    ...
    def __getattr__(self, name: str) -> typing.Any:
        ...
        if name == "version":
            ...
            def get_version(*args, **kwargs):  # noqa
                """
