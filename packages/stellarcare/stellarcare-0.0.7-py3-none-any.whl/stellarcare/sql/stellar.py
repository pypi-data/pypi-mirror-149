...
class Stellar:
    ...
    def build_feature_tbl(self, tbls = None):
        ...
        if self.stars:        
            sql = self.feature_tbl(cohort_tbl_nm = f'{self.group}_cohort', filter_to_obs_period = False, tbls = tbls)
            
        else:            
            sql = self.feature_tbl(cohort_tbl_nm = f'{self.group}_cohort', filter_to_obs_period = True, tbls = tbls)
...
GROUP BY a.alt_id_val, a.er_discharge
    ...
    def feature_tbl(self, cohort_tbl_nm, filter_to_obs_period, tbls = None):
