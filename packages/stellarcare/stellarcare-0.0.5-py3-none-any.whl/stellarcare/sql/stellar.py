...
class Stellar:
    ...
    def generate_queries(self):
        ...
        if self.treatment:
            ...
            if self.stars:
                ER_tbl_nm = f'{self.group}_er_eligible_stars'
    ...
    def build_cohort(self, steps = None, pre_ER_steps = None, post_ER_steps = None):
        ...
        if self.stars:
            ...
            self.remove_ineligible_due_to_ed(input_tbl_nm = f'{self.group}_er_eligible', output_tbl_nm = f'{self.group}_er_eligible_stars')
