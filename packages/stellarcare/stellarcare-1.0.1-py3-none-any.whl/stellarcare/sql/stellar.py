    ...
    def create_starting_cohort(self, output_tbl_nm):
        ...
        if self.treatment and self.stars:
            ...
            sql = f'''CREATE VOLATILE TABLE {output_tbl_nm} AS (                 
                    ...
                    WHERE b.proc_dt BETWEEN '2021-10-01' AND ADD_MONTHS(CURRENT_DATE(), -1)
                    AND b.srvc_strt_dt BETWEEN '2021-11-04' AND ADD_MONTHS(CURRENT_DATE(), -1)
                    ...
                    and b.udw_med_clm_id NOT IN (SELECT DISTINCT b.udw_med_clm_id
                                                ...
                                                AND b.proc_dt BETWEEN '2021-10-01' AND ADD_MONTHS(CURRENT_DATE(), -1)
                                                AND c.srvc_strt_dt BETWEEN '2021-11-04' AND ADD_MONTHS(CURRENT_DATE(), -1))
                    )
                    WITH DATA
                    ON COMMIT PRESERVE ROWS;
