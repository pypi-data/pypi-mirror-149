...
class pure_cloud(object):
    ...
    '''
    def __init__(self,fac,freq,group=10,boxcox=1,print_comments=1,plt_plot=1,plotly_plot=0,
    ...
    def run(self,print_comments,plt_plot,plotly_plot,filename):
        ...
        self.vs=[(((self.fac==i)+0).replace(0,np.nan)*self.rets).mean(axis=1).dropna() for i in range(self.group)]
