...
class SpellingErrorCorrection(object):
    ...
    @classmethod
    def initialize(cls, json_file):
        config = Config(json_file)
        global log
        global KO_WIKIPEDIA_ORG_SPELLING_ERROR_CORRECTION_MODEL_DIR
        global KO_WIKIPEDIA_ORG_TRAIN_SENTENCES_FILE
        global KO_WIKIPEDIA_ORG_VALID_SENTENCES_FILE
        global KO_WIKIPEDIA_ORG_TEST_SENTENCES_FILE
        global KO_WIKIPEDIA_ORG_CHARACTERS_FILE
        global KO_WIKIPEDIA_ORG_DIR
...
if __name__ == '__main__':
    json_file = 'D:\\python_workspace\\treform\\resources\\korean_spelling_config.json'
    SpellingErrorCorrection.initialize(json_file)
