...
class ModelDriver:
    ...
    def log_model(self, model, framework: str):
        """
        ...
        try:
            ...
            get_model_registry(framework).log_model(model, artifact_path=artifact_path)
        finally:
            if created_run:
    ...
    def get_model(self, dest_path: typing.Optional[str] = None, **kwargs):
        ...
        if model_artifact_log.framework is ModelFramework.TENSORFLOW:
            model_uri = model_artifact_log.artifact_path
        else:
