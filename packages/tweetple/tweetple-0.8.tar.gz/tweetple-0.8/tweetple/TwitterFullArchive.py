...
class TwitterObject:
    ...
    def query(self):
        ...
        query = {
            ...
            'tweet.fields': 'created_at,entities,geo,id,context_annotations,conversation_id,in_reply_to_user_id,lang,possibly_sensitive,public_metrics,referenced_tweets,reply_settings,source,text,withheld',
