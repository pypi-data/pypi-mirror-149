...
class TwitterObject:
    ...
    def query(self):
        ...
        query = {
            'tweet.fields': 'attachments,author_id,created_at,conversation_id,entities,geo,id,in_reply_to_user_id,lang,possibly_sensitive,public_metrics,referenced_tweets,reply_settings,source,text,withheld',
