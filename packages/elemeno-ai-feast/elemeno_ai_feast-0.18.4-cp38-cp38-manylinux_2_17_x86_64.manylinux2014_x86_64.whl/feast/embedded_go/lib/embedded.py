...
# gopy build -output /project/sdk/python/build/lib.linux-x86_64-cpython-38/feast/embedded_go/lib -vm /opt/python/cp38-cp38/bin/python -no-make github.com/feast-dev/feast/go/embedded
