...
# gopy build -output /project/sdk/python/build/lib.linux-x86_64-cpython-37/feast/embedded_go/lib -vm /opt/python/cp37-cp37m/bin/python -no-make github.com/feast-dev/feast/go/embedded
