...
from cytra import Application, json as jsonlib
from cytra.db import DatabaseManager, metadata
from cytra.helpers import NestedNamespace


class WebtestResponse(webtest.TestResponse):
    @property
    def json(self):
        return NestedNamespace(super().json)
...
class TestingApp:
    ...
    def __enter__(self):
        ...
        self.testapp = WebtestApp(self.app, json_encoder=jsonlib)
