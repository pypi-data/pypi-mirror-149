...
class AgoraDesk:
    ...
    def __init__(
        self: AD, api_key: Optional[str], debug: Optional[bool] = False
    ) -> None:
        self.api_key = ""
        if api_key:
    ...
    def account_info(self: AD, username: str) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def dashboard(
        ...
        params = {"page": f"{page}"} if page else None
        return self._api_call(api_method="dashboard", query_values=params)
    ...
    def dashboard_buyer(
        ...
        """
        params = {"page": f"{page}"} if page else None
        return self._api_call(api_method="dashboard/buyer", query_values=params)
    ...
    def dashboard_seller(
        ...
        """
        params = {"page": f"{page}"} if page else None
        return self._api_call(api_method="dashboard/seller", query_values=params)
    ...
    def dashboard_canceled(
        ...
        """
        params = {"page": f"{page}"} if page else None
        return self._api_call(api_method="dashboard/canceled", query_values=params)
    ...
    def dashboard_closed(
        ...
        """
        params = {"page": f"{page}"} if page else None
        return self._api_call(api_method="dashboard/closed", query_values=params)

    def dashboard_released(
        self: AD,
        page: Optional[int] = None,
    ) -> Dict[str, Any]:
        """See Agoradesk API.
        ...
        params = {"page": f"{page}"} if page else None
        return self._api_call(api_method="dashboard/released", query_values=params)

    def logout(self: AD) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def myself(self: AD) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def notifications(self: AD) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def notifications_mark_as_read(self: AD, notification_id: str) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def recent_messages(self: AD) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def feedback(
        self: AD, username: str, feedback: str, msg: Optional[str]
    ) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    #     post/contact_release/{trade_id} • Release a trade
    def contact_release(self: AD, trade_id: str) -> Dict[str, Any]:
    ...
    def contact_fund(self: AD, trade_id: str) -> Dict[str, Any]:
        """See Agoradesk API documentation.

        https://agoradesk.com/api-docs/v1#operation/fundTrade
        """
        return self._api_call(
            api_method=f"contact_fund/{trade_id}",
            http_method="POST",
        )

    #     post/contact_dispute/{trade_id} • Start a trade dispute
    def contact_dispute(self: AD, trade_id: str) -> Dict[str, Any]:
        """See Agoradesk API documentation.

        https://agoradesk.com/api-docs/v1#operation/startDispute
        """
        return self._api_call(
            api_method=f"contact_dispute/{trade_id}",
            http_method="POST",
        )

    #     post/contact_mark_as_paid/{trade_id} • Mark a trade as paid
    def contact_mark_as_paid(self: AD, trade_id: str) -> Dict[str, Any]:
        """See Agoradesk API.

        https://agoradesk.com/api-docs/v1#operation/markPaid
        """
        return self._api_call(
            api_method=f"contact_mark_as_paid/{trade_id}",
            http_method="POST",
        )
    ...
    def contact_escrow(
        ...
        https://agoradesk.com/api-docs/v1#operation/enableEscrow
        """
        return self._api_call(
            api_method=f"contact_escrow/{trade_id}",
            http_method="POST",
        )

    #     get/contact_messages/{trade_id} • Get trade messages
    def contact_messages(
        self: AD, trade_id: str, after: Optional[arrow.Arrow] = None
    ) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def contact_create(
        ...
        buyer_settlement_fee_level: Optional[str] = None,
    ) -> Dict[str, Any]:
        """See Agoradesk API.
        ...
        if buyer_settlement_fee_level:
            payload["buyer_settlement_fee_level"] = buyer_settlement_fee_level
        return self._api_call(
    ...
    def contact_info(self: AD, trade_ids: Union[str, List[str]]) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    #     Todo: Add image upload functionality   # pylint: disable=W0511
    #     post/contact_message_post/{trade_id} • Send a chat message/attachment
    def contact_message_post(
        self: AD, trade_id: str, msg: Optional[str] = None
    ) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def contact_message_attachment(
        self: AD, trade_id: str, attachment_id: str
    ) -> Dict[str, Any]:
        """See Agoradesk API.

        https://agoradesk.com/api-docs/v1#operation/getChatAttachment
        """
        return self._api_call(
            api_method=f"contact_message_post/{trade_id}/{attachment_id}",
            http_method="POST",
        )
    ...
    def ad_create(  # noqa: max-complexity: 18
        self: AD,
        country_code: str,
        currency: str,
        trade_type: str,
        ...
        if buyer_settlement_fee_level:
            params["buyer_settlement_fee_level"] = buyer_settlement_fee_level
        if online_provider:
    ...
    def ad_equation(self: AD, ad_id: str, price_equation: str) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def ad_delete(self: AD, ad_id: str) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def ad_get(self: AD, ad_ids: List[str]) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def payment_methods(self: AD, country_code: Optional[str] = None) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def country_codes(self: AD) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def currencies(self: AD) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def equation(self: AD, price_equation: str, currency: str) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    @staticmethod
    def _generic_search_parameters(
        amount: Optional[float] = None,
        page: Optional[int] = None,
    ...
    def moneroaverage(
        self: AD, currency: Optional[str] = "ticker-all-currencies"
    ) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def wallet(self: AD) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def wallet_balance(self: AD) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def wallet_xmr(self: AD) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def wallet_balance_xmr(self: AD) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def wallet_addr(self: AD) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def wallet_addr_xmr(self: AD) -> Dict[str, Any]:
        """See Agoradesk API.
    ...
    def fees(self: AD, address: Optional[str] = None) -> Dict[str, Any]:
        """See Agoradesk API.
        ...
        return self._api_call(api_method="fees", query_values=params)

    def fees_xmr(self: AD) -> Dict[str, Any]:
        """See Agoradesk API.
