...
def get_parser(ap=None):
    ...
    if ap is None:
        ...
        ap.add_argument(
            "--logfile", type=str, default="make_dataset.log", help="Logging output",
        )
...
def make_dataset(
    ...
    raw (bool): If True, the .raw.X slot of the AnnData is used to read the counts matrix, instead of .X
