...
class ArbaPerceptionLine(PresentationLine):
    ...
    def basePercepcion(self, basePercepcion):
        self._basePercepcion = self._fill_and_validate_len(basePercepcion, 'basePercepcion', 12)
    ...
    def importePercepcion(self, importePercepcion):
        self._importePercepcion = self._fill_and_validate_len(importePercepcion, 'importePercepcion', 11)
