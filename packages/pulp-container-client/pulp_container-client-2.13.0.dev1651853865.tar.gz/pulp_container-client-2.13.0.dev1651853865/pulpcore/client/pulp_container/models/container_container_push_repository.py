...
class ContainerContainerPushRepository(object):
    ...
    def __init__(self, retain_repo_versions=None, manifest_signing_service=None, pulp_labels=None, name=None, description=None, local_vars_configuration=None):  # noqa: E501
