...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retain_repo_versions=None, pulp_href=None, versions_href=None, manifest_signing_service=None, pulp_labels=None, name=None, description=None, latest_version_href=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
