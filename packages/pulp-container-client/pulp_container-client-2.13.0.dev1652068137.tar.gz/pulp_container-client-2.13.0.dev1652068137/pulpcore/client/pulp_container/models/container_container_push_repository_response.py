...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, name=None, manifest_signing_service=None, pulp_href=None, description=None, versions_href=None, latest_version_href=None, retain_repo_versions=None, pulp_created=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
