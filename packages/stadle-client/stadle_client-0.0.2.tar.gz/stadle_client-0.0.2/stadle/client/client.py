...
class Client:
    ...
    def __init__(self,
        ...
        self.comm_handler = CommunicationHandler(self.comm_protocol)
        ...
        if ('check_bm_type' in self.config):
            self.check_bm_type = self.config['check_bm_type']
        else:
...
class BasicClient(Client):
    def __init__(self, config_file: str = None,
        ...
        if (use_cl_args):
            ...
            if args.comm_protocol:
                comm_protocol = args.comm_protocol
            if args.aggregator_ip:
