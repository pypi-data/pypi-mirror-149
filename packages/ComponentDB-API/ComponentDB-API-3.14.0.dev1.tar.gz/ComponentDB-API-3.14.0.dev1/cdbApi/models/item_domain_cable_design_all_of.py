...
class ItemDomainCableDesignAllOf(object):
    ...
    def __init__(self, catalog_item=None, technical_system_list=None, alternate_name=None, catalog_item_id=None, catalog_item_string=None, local_vars_configuration=None):  # noqa: E501
