...
install_requires = \
['packaging', 'ply>=3.11,<4.0', 'six']

extras_require = \
{':python_version >= "2.7" and python_version < "2.8"': ['click>=7.1.2,<8.0.0',
                                                         'numpy<=1.16.6'],
 ':python_version >= "3.6"': ['click>=8.0.4,<9.0.0', 'numpy>=1.19.4,<2.0.0'],
 'netcdf': ['netCDF4<1.5.6', 'cftime==1.5.1.1']}
