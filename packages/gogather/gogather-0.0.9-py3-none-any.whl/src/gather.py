...
def main():
        ...
        parser.add_argument('-en', action='store', dest='enable', type=int, help='Please enter the enable password only if you explicity wish to be in enable mode',default='gatherdefault')
