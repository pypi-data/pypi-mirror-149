...
class ServerStorage:
    ...
    """
    class AllUsers:
        """Класс-отображение все пользователи"""
    ...
    def __init__(self, path):
        ...
        users_history_table: Table = Table('History', self.metadata,
                                    Column('id', Integer, primary_key=True),
                                    Column('user', ForeignKey('Users.id')),
                                    Column('sent', Integer),
        ...
        # Создаём сессию
        Session: sessionmaker = sessionmaker(bind=self.database_engine)
    ...
    def process_message(self, sender, recipient) -> None:
        """
        Метод фиксирует передачу сообщения и делает соответствующие отметки в
        БД
        :param sender:
        :param recipient:
        :return: None
    ...
    def add_contact(self, user, contact) -> None:
        """
