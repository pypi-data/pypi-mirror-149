...
class MainWindow(QMainWindow):
    ...
    def __init__(self, database, server, config):
        ...
        # размер окна фиксировандля упрощения
        ...
        # таймер, обновляющий список клиентов 1 раз в сек.
        self.timer = QTimer()
        ...
        self.refresh_button.triggered.connect(
            self.create_users_model)  # метод далее
        self.show_history_button.triggered.connect(
            self.show_statistics)  # метод далее
        self.config_btn.triggered.connect(self.server_config)  # метод далее
        self.register_btn.triggered.connect(self.reg_user)  # метод далее
        self.remove_btn.triggered.connect(self.rem_user)  # метод далее
