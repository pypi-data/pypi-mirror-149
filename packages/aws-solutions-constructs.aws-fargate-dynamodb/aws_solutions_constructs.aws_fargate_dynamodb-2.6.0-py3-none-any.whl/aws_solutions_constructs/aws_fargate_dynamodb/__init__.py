...
class FargateToDynamoDB(
    ...
    def __init__(
        ...
        *,
        ...
        :param table_arn_environment_variable_name: Optional Name for the DynamoDB table arn environment variable set for the container. Default: - None
        :param table_environment_variable_name: Optional Name for the DynamoDB table name environment variable set for the container. Default: - None
