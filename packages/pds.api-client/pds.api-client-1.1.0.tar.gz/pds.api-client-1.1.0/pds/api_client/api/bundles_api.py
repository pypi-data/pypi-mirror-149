...
class BundlesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.bundle_by_lidvid_endpoint = _Endpoint(
            settings={
        ...
        self.bundle_by_lidvid_all_endpoint = _Endpoint(
            settings={
        ...
        self.bundle_by_lidvid_latest_endpoint = _Endpoint(
            settings={
                'response_type': (PdsProduct,),
                'auth': [],
    ...
    def bundle_by_lidvid(
        self,
        identifier,
        **kwargs
    ):
        """returns one product with the identifier selected from all PDS bundles. See identifier for details on how it determines what is returned.   # noqa: E501
    ...
    def bundle_by_lidvid_all(
        self,
        identifier,
        **kwargs
    ):
        """returns all product versions with the identifier (lid) selected from all PDS bundles. See identifier for details on how it determines what is returned.   # noqa: E501
        ...
        kwargs['identifier'] = \
            identifier
        return self.bundle_by_lidvid_all_endpoint.call_with_http_info(**kwargs)

    def bundle_by_lidvid_latest(
        self,
        identifier,
        **kwargs
    ):
        ...
        kwargs['identifier'] = \
            identifier
        return self.bundle_by_lidvid_latest_endpoint.call_with_http_info(**kwargs)

    def get_bundles(
        self,
        **kwargs
    ):
        """returns all PDS bundles that meet all given constraints.   # noqa: E501
