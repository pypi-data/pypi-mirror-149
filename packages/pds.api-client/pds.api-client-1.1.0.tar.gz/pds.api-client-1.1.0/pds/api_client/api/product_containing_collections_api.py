...
class ProductContainingCollectionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.collections_containing_product_endpoint = _Endpoint(
            settings={
    ...
    def collections_containing_product(
        self,
        identifier,
        **kwargs
    ):
        """returns one or more collections that contain or reference the product specified by identifier selected from all PDS data products, including bundles, collections, documentation, context and observational products. See identifier for details on how it determines what is returned.           # noqa: E501
        ...
        kwargs['identifier'] = \
            identifier
        return self.collections_containing_product_endpoint.call_with_http_info(**kwargs)
