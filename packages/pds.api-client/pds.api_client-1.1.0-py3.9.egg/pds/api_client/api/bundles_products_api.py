...
class BundlesProductsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.products_of_a_bundle_endpoint = _Endpoint(
            settings={
    ...
    def products_of_a_bundle(
        self,
        identifier,
        **kwargs
    ):
        """returns one or more latest version products that are contained or referenced by the bundle specified by identifier. See identifier for details on how it determines what is returned.   # noqa: E501
        ...
        kwargs['identifier'] = \
            identifier
        return self.products_of_a_bundle_endpoint.call_with_http_info(**kwargs)
