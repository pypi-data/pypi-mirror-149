...
class CollectionsContainingBundlesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.bundles_containing_collection_endpoint = _Endpoint(
            settings={
    ...
    def bundles_containing_collection(
        self,
        identifier,
        **kwargs
    ):
        """returns one or more bundles that contain or reference the product specified by identifier selected from all PDS collections. See identifier for details on how it determines what is returned.   # noqa: E501
        ...
        kwargs['identifier'] = \
            identifier
        return self.bundles_containing_collection_endpoint.call_with_http_info(**kwargs)
