...
class TrainAlgorithmConfig:
    ...
    def hyperparameters(self, value: List[str]) -> None:
        _set_attribute(self._attributes, "TrainAlgorithmConfig", "hyperparameters", value, List[str], "")


    @classmethod
    def from_proto(cls: Type[T], proto: management_types_pb2.TrainAlgorithmConfig, **kwargs) -> T:
        """Convert object from proto representation."""
        return cls(**MessageToDict(proto, preserving_proto_field_name=True), **kwargs)

    def to_proto(self) -> management_types_pb2.TrainAlgorithmConfig:
        """Convert object to proto representation."""
        return management_types_pb2.TrainAlgorithmConfig(**_to_proto_dict(self._attributes))
    ...
    def __repr__(self) -> str:
        return "<TrainAlgorithmConfig object " + repr(self.to_dict()) + ">"
...
class TrainConfig:
    ...
    def __init__(self
        ...
        , size_limit: int = 0
        , log_level: str = ""
        , train_algorithm_configs: Dict[str, TrainAlgorithmConfig] = None
    , **kwargs) -> TrainConfig:
        self._attributes = dict()
        ...
        self.train_algorithm_configs = train_algorithm_configs
    ...
    @property
    def advanced_parameters(self) -> str:
        """Advanced parameters."""
        return self._attributes["advanced_parameters"]


    @advanced_parameters.setter
    def advanced_parameters(self, value: str) -> None:
        _set_attribute(self._attributes, "TrainConfig", "advanced_parameters", value, str, "")
    ...
    @property
    def train_algorithm_configs(self) -> Dict[str, TrainAlgorithmConfig]:
        """Train algorithm configs."""
        return self._attributes["train_algorithm_configs"]


    @train_algorithm_configs.setter
    def train_algorithm_configs(self, value: Dict[str, TrainAlgorithmConfig]) -> None:
        _set_attribute(self._attributes, "TrainConfig", "train_algorithm_configs", value, Dict[str, TrainAlgorithmConfig], "")
