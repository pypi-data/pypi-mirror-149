...
def mi_endpoint_save(name: str, ip: str, port: str, usr: str, pwd: str) -> Endpoint:
...
def mi_endpoint_change_pwd(name: str, pwd: str) -> Endpoint:
    endpoints = mi_endpoint_list()
    keyring.set_password(SERVICE_ID, name, pwd)
