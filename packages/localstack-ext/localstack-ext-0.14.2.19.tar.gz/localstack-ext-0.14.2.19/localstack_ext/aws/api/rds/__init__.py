...
class VpnDetails(TypedDict, total=False):
    ...
    Guide. <https://docs.aws.amazon.com/AmazonRDS/latest/RDSonVMwareUserGuide/rds-on-vmware.html>`__
    """
...
class ScalingConfiguration(TypedDict, total=False):
    ...
    Serverless <https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-serverless.html>`__
    in the *Amazon Aurora User Guide*.
    """
...
class RdsApi:
    ...
    def create_custom_availability_zone(
        ...
        :param custom_availability_zone_name: The name of the custom Availability Zone (AZ).
        :param existing_vpn_id: The ID of an existing virtual private network (VPN) between the Amazon
        RDS website and the VMware vSphere cluster.
        :param new_vpn_tunnel_name: The name of a new VPN tunnel between the Amazon RDS website and the
        VMware vSphere cluster.
        :param vpn_tunnel_originator_ip: The IP address of network traffic from your on-premises data center.
        :returns: CreateCustomAvailabilityZoneResult
        :raises CustomAvailabilityZoneAlreadyExistsFault:
        :raises CustomAvailabilityZoneQuotaExceededFault:
        :raises KMSKeyNotAccessibleFault:
        """
        raise NotImplementedError
    ...
    def delete_custom_availability_zone(
        ...
        :param custom_availability_zone_id: The custom AZ identifier.
        :returns: DeleteCustomAvailabilityZoneResult
        :raises CustomAvailabilityZoneNotFoundFault:
        :raises KMSKeyNotAccessibleFault:
        """
        raise NotImplementedError
    ...
    def delete_installation_media(
        ...
        :param installation_media_id: The installation medium ID.
        :returns: InstallationMedia
        :raises InstallationMediaNotFoundFault:
        """
        raise NotImplementedError
    ...
    def describe_custom_availability_zones(
        ...
        :returns: CustomAvailabilityZoneMessage
        :raises CustomAvailabilityZoneNotFoundFault:
        """
        raise NotImplementedError
    ...
    def describe_installation_media(
        ...
        :param max_records: An optional pagination token provided by a previous
        DescribeInstallationMedia request.
        :param marker: An optional pagination token provided by a previous request.
        :returns: InstallationMediaMessage
        :raises InstallationMediaNotFoundFault:
        """
        raise NotImplementedError
    ...
    def import_installation_media(
        ...
        :param custom_availability_zone_id: The identifier of the custom Availability Zone (AZ) to import the
        installation media to.
        :param engine: The name of the database engine to be used for this instance.
        :param engine_version: The version number of the database engine to use.
        :param engine_installation_media_path: The path to the installation medium for the specified DB engine.
        :param os_installation_media_path: The path to the installation medium for the operating system associated
        with the specified DB engine.
        :returns: InstallationMedia
        :raises CustomAvailabilityZoneNotFoundFault:
        :raises InstallationMediaAlreadyExistsFault:
        """
        raise NotImplementedError
    ...
    def modify_current_db_cluster_capacity(
        ...
        scaling points, see `Autoscaling for Aurora
        Serverless <https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-serverless.how-it-works.html#aurora-serverless.how-it-works.auto-scaling>`__
        in the *Amazon Aurora User Guide*.
        ...
        :param seconds_before_timeout: The amount of time, in seconds, that Aurora Serverless tries to find a
