...
class LegacyTranslationEnum:
    ...
    EXPORTING_SUPPORT_OLDER_ANKI_VERSIONS = (16, 21)
    ...
    IMPORTING_IMPORTING_FILE = (19, 26)
    IMPORTING_INVALID_FILE_PLEASE_RESTORE_FROM_BACKUP = (19, 27)
    IMPORTING_MAP_TO = (19, 28)
    IMPORTING_MAP_TO_TAGS = (19, 29)
    IMPORTING_MAPPED_TO = (19, 30)
    IMPORTING_MAPPED_TO_TAGS = (19, 31)
    IMPORTING_MNEMOSYNE_20_DECK_DB = (19, 32)
    IMPORTING_MULTICHARACTER_SEPARATORS_ARE_NOT_SUPPORTED_PLEASE = (19, 33)
    IMPORTING_NOTE_ADDED = (19, 34)
    IMPORTING_NOTE_IMPORTED = (19, 35)
    IMPORTING_NOTE_UNCHANGED = (19, 36)
    IMPORTING_NOTE_UPDATED = (19, 37)
    IMPORTING_NOTES_ADDED_FROM_FILE = (19, 38)
    IMPORTING_NOTES_FOUND_IN_FILE = (19, 39)
    IMPORTING_NOTES_SKIPPED_AS_THEYRE_ALREADY_IN = (19, 40)
    IMPORTING_NOTES_THAT_COULD_NOT_BE_IMPORTED = (19, 41)
    IMPORTING_NOTES_UPDATED_AS_FILE_HAD_NEWER = (19, 42)
    IMPORTING_PACKAGED_ANKI_DECKCOLLECTION_APKG_COLPKG_ZIP = (19, 43)
    IMPORTING_PAUKER_18_LESSON_PAUGZ = (19, 44)
    IMPORTING_PROCESSED_MEDIA_FILE = (19, 45)
    IMPORTING_PROCESSED_NOTES = (19, 46)
    IMPORTING_ROWS_HAD_NUM1D_FIELDS_EXPECTED_NUM2D = (19, 47)
    IMPORTING_SELECTED_FILE_WAS_NOT_IN_UTF8 = (19, 48)
    IMPORTING_SEMICOLON = (19, 49)
    IMPORTING_SKIPPED = (19, 50)
    IMPORTING_SUPERMEMO_XML_EXPORT_XML = (19, 51)
    IMPORTING_TAB = (19, 52)
    IMPORTING_TAG_MODIFIED_NOTES = (19, 53)
    IMPORTING_TEXT_SEPARATED_BY_TABS_OR_SEMICOLONS = (19, 54)
    IMPORTING_THE_FIRST_FIELD_OF_THE_NOTE = (19, 55)
    IMPORTING_THE_PROVIDED_FILE_IS_NOT_A = (19, 56)
    IMPORTING_THIS_FILE_DOES_NOT_APPEAR_TO = (19, 57)
    IMPORTING_THIS_WILL_DELETE_YOUR_EXISTING_COLLECTION = (19, 58)
    IMPORTING_UNABLE_TO_IMPORT_FROM_A_READONLY = (19, 59)
    IMPORTING_UNKNOWN_FILE_FORMAT = (19, 60)
    IMPORTING_UPDATE_EXISTING_NOTES_WHEN_FIRST_FIELD = (19, 61)
    IMPORTING_UPDATED = (19, 62)
    KEYBOARD_CTRL = (20, 0)
    KEYBOARD_SHIFT = (20, 1)
...
Debug info: '''
    ...
    def importing_map_to(self, val: FluentVariable) -> str:
        r''' Map to {$val} '''
        return self._translate(19, 28, {"val": val})
    ...
    def importing_processed_notes(self, count: int) -> str:
        ...
        return self._translate(19, 46, {"count": count})
    ...
    def importing_rows_had_num1d_fields_expected_num2d(self, row: str, found: FluentVariable, expected: FluentVariable) -> str:
        ...
        return self._translate(19, 47, {"row": row, "found": found, "expected": expected})
