...
from piri2.casting import get_casting_function
from piri2.constants import (  # noqa: WPS235
    CONDITION,
    CONTAINS,
    DEFAULT_GROUP,
    FROM,
...
from piri2.valuetypes import MapValue, NewValue, ValueTypes
...
def apply_regexp(  # noqa: WPS212, WPS234
    ...
    Example
        >>> from piri2.functions import apply_regexp
