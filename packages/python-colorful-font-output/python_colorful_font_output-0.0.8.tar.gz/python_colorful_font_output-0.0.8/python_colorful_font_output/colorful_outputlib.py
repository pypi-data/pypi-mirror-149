...
class Help:
    ...
    def ask_the_module_questions(self):
        ...
        if answer == "Run the module's tips":
            ...
            python-colorful-font-output               0.0.7(This version)
            ...
            N0.2 Remove main file, change to some classes and defined functions to do more complex than <python-colorful
                 -font-output-0.0.4> and <python-colorful-font-output-0.0.5>.
            No.3 Update: remove rich.console.Console, add it in class RichColorfulOutput.
            ...
            No.6 Remove error, for example: In the module '.' writes to ','.
            """)
            ...
            python-colorful-font-output   2022.05.05 20:21       0.0.7(This version)
