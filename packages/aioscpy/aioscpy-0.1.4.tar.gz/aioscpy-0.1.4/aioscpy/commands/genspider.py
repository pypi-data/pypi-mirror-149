...
class Command(ScrapyCommand):
    ...
    def short_desc(self):
        return "Generate new spider using pre-defined templates_bak1"

    def add_options(self, parser):
        ScrapyCommand.add_options(self, parser)
        parser.add_argument("-l", "--list", dest="list", action="store_true",
                            help="List available templates_bak1")
    ...
    def _find_template(self, template):
        ...
        print('Use "scrapy genspider --list" to see all available templates_bak1.')

    def _list_templates(self):
        print("Available templates_bak1:")
    ...
    def templates_dir(self):
        return join(
            self.settings['TEMPLATES_DIR'] or join(aioscpy.__path__[0], 'templates_bak1'),
            'spiders'
        )
