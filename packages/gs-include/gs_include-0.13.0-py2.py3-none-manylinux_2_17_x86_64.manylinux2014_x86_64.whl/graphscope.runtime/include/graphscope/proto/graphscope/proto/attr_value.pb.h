...
class AttrValue PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    ...
    kModifyTypeFieldNumber = 9,
    kReportTypeFieldNumber = 10,
    kListFieldNumber = 11,
    kFuncFieldNumber = 12,
  ...
  // .gs.rpc.graph.GraphTypePb graph_type = 8;
  private:
  ...
  // .gs.rpc.ModifyType modify_type = 9;
  private:
  ...
  // .gs.rpc.ReportType report_type = 10;
  private:
