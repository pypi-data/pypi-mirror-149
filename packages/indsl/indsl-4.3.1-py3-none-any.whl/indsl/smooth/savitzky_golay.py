...
def sg(data: pd.Series, window_length: int = None, polyorder: int = 1) -> pd.Series:
    ...
    Args:
        ...
        window_length (int, optional): Window.
        ...
        polyorder (int, optional): Polynomial order.
            The order of the polynomial used to fit the samples. Must be less than filter window length.Defaults to 1.
