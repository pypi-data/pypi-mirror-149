...
import scipy as sc
import logging
from rohan.lib.sys import info
...
def get_corr_bootstrapped(x: np.array,
    ...
    """
    from rohan.stat.classify import get_cvsplits
    from rohan.stat.variance import get_ci
...
def corr_to_str(method: str,
    ...
    from rohan.lib.str import num2str
...
def get_corrs(df1,
    ...
    """
    import itertools
    from rohan.stat.diff import get_q
    # check inflation/over-representations
    from rohan.lib.df import check_inflation
...
def check_collinearity(
    ...
    from rohan.stat.network import get_subgraphs
