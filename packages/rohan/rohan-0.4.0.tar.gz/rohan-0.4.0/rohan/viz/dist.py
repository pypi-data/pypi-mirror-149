...
def hist_annot(
    ...
    **kws,
    ...
    """
    from rohan.viz.ax_ import reset_legend_colors
    if not xlim is None:
    ...
    from rohan.viz.colors import get_ncolors
...
def plot_gmm(
    ...
    **kws,
    ...
    """
    if mix_pdf is None:
        from rohan.stat.cluster import cluster_1d
        d_=cluster_1d(x,
...
def plot_dists(
    ...
    **kws
    ...
    if (hue is None) and (isinstance(show_p,bool) and show_p):
        from rohan.stat.diff import get_stats
        df2=get_stats(df1,
                      colindex=colindex,
                          colsubset=y,
                          cols_value=[x],
        ...
        from rohan.stat.diff import get_stats_groupby
