...
from rohan.lib.str import make_pathable_string
...
#     from rohan.viz.ax_ import set_label
...
#         from rohan.stat.corr import get_corr
...
def plot_scatter(
    ...
    **kws,
    ...
    TODOs:
        1. Access the function as an attribute of rohan-data i.e. `rd`. 
    ...
    from rohan.viz.ax_ import set_label_colorbar
#     print(colz)
...
def plot_qq(
    ...
    from rohan.viz.ax_ import set_equallim
    ax=set_equallim(ax)
    return ax
