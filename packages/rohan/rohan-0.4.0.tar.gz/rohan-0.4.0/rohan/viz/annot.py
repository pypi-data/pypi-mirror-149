...
import pandas as pd
import logging
from rohan.lib.str import *

# redirects
from rohan.stat.io import perc_label,pval2annot
...
def annot_side(
    ...
    **kws_text,
    ...
    from rohan.viz.ax_ import get_axlims
    d1=get_axlims(ax)
...
def annot_confusion_matrix(
    ...
    Returns:
        plt.Axes: `plt.Axes` object.
    """
    from rohan.stat.binary import get_stats_confusion_matrix
