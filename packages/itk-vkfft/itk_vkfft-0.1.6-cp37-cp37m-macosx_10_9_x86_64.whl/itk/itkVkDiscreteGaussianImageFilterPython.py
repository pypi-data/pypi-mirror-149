...
def vk_discrete_gaussian_image_filter(*args: itkt.ImageLike,  anticipated_performance_metric_threshold: float=..., variance: Union[float, Sequence[float]]=..., maximum_error: Union[float, Sequence[float]]=..., maximum_kernel_width: int=..., filter_dimensionality: int=..., input_boundary_condition: itkt.ImageBoundaryCondition=..., real_boundary_condition: itkt.ImageBoundaryCondition=..., sigma_array: Sequence[float]=..., sigma: float=..., use_image_spacing: bool=...,**kwargs)-> itkt.ImageSourceReturn:
    """Functional interface for VkDiscreteGaussianImageFilter"""
    import itk

    kwarg_typehints = { 'anticipated_performance_metric_threshold':anticipated_performance_metric_threshold,'variance':variance,'maximum_error':maximum_error,'maximum_kernel_width':maximum_kernel_width,'filter_dimensionality':filter_dimensionality,'input_boundary_condition':input_boundary_condition,'real_boundary_condition':real_boundary_condition,'sigma_array':sigma_array,'sigma':sigma,'use_image_spacing':use_image_spacing }
