...
class GltfForwardTranslator(object):
    ...
    def __init__(self):
        _openstudiomodelgenerators.GltfForwardTranslator_swiginit(self, _openstudiomodelgenerators.new_GltfForwardTranslator())

    def modelToGLTF(self, model: "Model", outputPath: "path") -> "bool":
        return _openstudiomodelgenerators.GltfForwardTranslator_modelToGLTF(self, model, outputPath)

    def createTriangleGLTF(self, outputPath: "path") -> "bool":
        return _openstudiomodelgenerators.GltfForwardTranslator_createTriangleGLTF(self, outputPath)

    def createTriangleGLTFFromPoint3DVector(self, outputPath: "path") -> "bool":
        return _openstudiomodelgenerators.GltfForwardTranslator_createTriangleGLTFFromPoint3DVector(self, outputPath)

    def loadGLTF(self, inputPath: "path", inputNonEmbededpath: "path") -> "bool":
        return _openstudiomodelgenerators.GltfForwardTranslator_loadGLTF(self, inputPath, inputNonEmbededpath)

    def warnings(self) -> "std::vector< openstudio::LogMessage,std::allocator< openstudio::LogMessage > >":
        return _openstudiomodelgenerators.GltfForwardTranslator_warnings(self)

    def errors(self) -> "std::vector< openstudio::LogMessage,std::allocator< openstudio::LogMessage > >":
        return _openstudiomodelgenerators.GltfForwardTranslator_errors(self)
    __swig_destroy__ = _openstudiomodelgenerators.delete_GltfForwardTranslator

# Register GltfForwardTranslator in _openstudiomodelgenerators:
_openstudiomodelgenerators.GltfForwardTranslator_swigregister(GltfForwardTranslator)
