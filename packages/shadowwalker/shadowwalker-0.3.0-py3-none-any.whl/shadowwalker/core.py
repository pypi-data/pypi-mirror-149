    ...
    def update_proxies(self):
        ...
        for i in range(0, 10):
            try:
                ...
                if os.path.isfile("proxies_cache.yaml") and os.path.getctime("proxies_cache.yaml")+60*60*24 > time.time():
...
'''.format(
    ...
    def test_latency(self, exclude_country):
        ...
        ping_cache = {}
        if os.path.isfile("ping_cache.json") and os.path.getctime("ping_cache.json")+60*60*24 > time.time():
