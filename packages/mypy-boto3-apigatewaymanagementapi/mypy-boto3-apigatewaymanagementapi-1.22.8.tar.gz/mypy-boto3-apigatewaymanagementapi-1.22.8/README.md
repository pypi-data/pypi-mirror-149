...
[boto3.ApiGatewayManagementApi 1.22.8](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/apigatewaymanagementapi.html#ApiGatewayManagementApi)
