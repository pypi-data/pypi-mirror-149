    ...
    def autosegmentation(self):
        ...
        if self.imagePath != None:
            ...
            if self.imagePath.endswith((".png", ".tiff", "tif")):
                ...
                # todo: FOV default value and calculation
                FOV = 500
                FOV, ok = QtWidgets.QInputDialog().getInt(self,
                                                          ...
                                                          FOV)
                if ok and FOV:
                    #todo adapt FOV to currently used model
                    zoom_factor = (500/FOV)
...
#            self.frameRate = frameRate
    ...
    def extractTraces(self, imagesArray):  # , frequency):
        ...
        with Pool() as pool:
            traces = pool.starmap(tracesForImage, zip(imagesArray, repeat(masks)))
