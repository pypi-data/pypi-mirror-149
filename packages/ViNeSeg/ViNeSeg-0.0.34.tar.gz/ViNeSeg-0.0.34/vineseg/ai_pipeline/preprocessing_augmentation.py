...
from monai.data import WSIReader, ITKReader
...
def preprocessing( list_steps, zoom_factor = 1, image_size = 512):
    preprocessing_list = []
...
def feature_engineering(list_preprocessing_functions):
    ...
    #todo: fix this (WSIReader seems required for tif)
#    feature_engineering_list.append(LoadImaged(keys=keys, reader=WSIReader))
    feature_engineering_list.append(LoadImaged(keys=keys, reader=ITKReader))
