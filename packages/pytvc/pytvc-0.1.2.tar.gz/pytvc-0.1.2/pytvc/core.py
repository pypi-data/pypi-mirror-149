...
class simulation:
    ...
    def __init__(self, plot_data: bool = True, wind_speed: float = 0.5, time_step: float = 0.001, time_end: float = 60.0, rockets: dict = {}, print_times: bool = True, print_info: bool = True, wind: Vec3 = Vec3(), sim_wind: bool = False, random_wind: bool = False) -> None:
        self.time: float = 0.0
        self.time_step = time_step
        ...
        if random_wind:
            self.wind: Vec3 = Vec3(0.0, np.random.normal(0.0, wind_speed, 1)[
                                   0], np.random.normal(0.0, wind_speed, 1)[0])
        else:
            self.wind: Vec3 = wind
