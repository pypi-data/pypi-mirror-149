...
def test_parse_action_with_function_equality_precondition_sets_a_new_numeric_precondition(domain_parser: DomainParser):
    ...
    for numeric_precond in domain.actions["pour"].numeric_preconditions:
