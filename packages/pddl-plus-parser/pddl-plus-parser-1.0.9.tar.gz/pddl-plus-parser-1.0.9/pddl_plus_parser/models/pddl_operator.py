...
class Operator:
    ...
    def ground(self) -> NoReturn:
        ...
        self.grounded_equality_preconditions = self.ground_equality_objects(self.action.equality_preconditions, parameters_map)
        self.grounded_inequality_preconditions = self.ground_equality_objects(self.action.inequality_preconditions, parameters_map)
