    ...
    def __init__(self, path=':memory:', connection=None):
        ...
        if path != ':memory:':
            ...
            for table_name in all_tables:
                self.tables[table_name] = table_name[0]
