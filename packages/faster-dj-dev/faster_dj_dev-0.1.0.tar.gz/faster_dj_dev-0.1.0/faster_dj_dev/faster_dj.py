...
@click.option("--install","-i",multiple=True,type=click.Choice(["djangorestframework", "django-cors-headers", "crispy-tailwind","django-unicorn", "tailwind", "django-htmx", "django-dbbackup", "django-cron"],  case_sensitive=False),help="Install Django package.")
...
def main(create_project, app, config_templates, config_static, config_media,
         ...
         init, working_directory, project_folder, starter
        ):
