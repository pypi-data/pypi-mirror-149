...
class ModelWrapper:
    ...
    * object: The wrapped model instance. Will include URLs
    ...
    cancel_attr: str = "cancel"
    cancel_url_name: Optional[str] = None  # dict key for edc_dashboard.url_names
    cancel_url_attrs: List[str] = []
    next_attr: str = "next"
    next_url_name: Optional[str] = None  # dict key for edc_dashboard.url_names
    ...
    def __init__(
        ...
        cancel_url_name: Optional[str] = None,
        cancel_url_attrs: Optional[List[str]] = None,
        next_url_name: Optional[Any] = None,
        next_url_attrs: Optional[List[str]] = None,
        querystring_attrs: Optional[List[str]] = None,
