...
LONG_DESCRIPTION = 'A package for linear algebra operations. Now includes a linear regression function with multiple models, compatible with matplotlib graphing functions!'
