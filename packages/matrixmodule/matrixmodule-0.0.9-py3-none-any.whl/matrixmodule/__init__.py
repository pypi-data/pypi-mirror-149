...
general = {
    ...
    "nthRegression()": ["none", "Computes an nth-degree regression by the least squares method and returns the best fit polynomial"]
}
...
def modulehelp(rep=0):
    if(rep == 0):
        print("This is the Matrix Module V0.0.9, a package created by Elliott Walker. Type 'funcs' for a list of available functions, 'details' for a more detailed list including parameters, or 'exit' to exit this help function.")
    else:
