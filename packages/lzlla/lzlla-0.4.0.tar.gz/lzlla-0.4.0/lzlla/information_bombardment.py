...
"""
from lzlla import information_bombardment
中文版：
...
def information_bombardment_Chinese():
    root = Tk()
    root.title('by龙·玛卡巴卡的小推车·卓·弘弘‘s_buddy·李')
...
def information_bombardment_English():
    root = Tk()
    root.title('by Long·Makabaka`s_bogey_dolly_trolley·Zhuo·honghong`s_buddy·Li')
