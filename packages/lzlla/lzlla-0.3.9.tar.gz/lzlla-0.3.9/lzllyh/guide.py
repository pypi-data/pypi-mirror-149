...
def guide():
    """
    import lzlla import guide
    guide.guide()
    """
    print('======================================================================')
    print('欢迎下载我的第三方模块0.3.0版')
    print('Welcome to download my third-party module-0.3.0')
    time.sleep(2)
    print('==========================================================================================')
    print('本模块是由多人联合完成的模块')
    print('==========================================================================================')
    print('author/name/connecting_points/connecting_points_tester/information_bombardment')
    print('请输入需要查询的函数 ')
