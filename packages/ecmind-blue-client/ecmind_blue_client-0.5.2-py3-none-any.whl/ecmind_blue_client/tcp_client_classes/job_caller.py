...
class JobCaller:
    ...
    def parse_parameters(self, params_raw):
        ...
        for i in range(0, params_count):
            ...
            name_offset = unpack(
                ">i", params_raw[description_offset : description_offset + 4]
            )[0]
            param_type = unpack(
                ">i", params_raw[description_offset + 4 : description_offset + 8]
            )[0]
            value_offset = unpack(
                ">i", params_raw[description_offset + 8 : description_offset + 12]
            )[0]
