    ...
    def __str__(self):
        ...
        if self.FULLTEXTFILEATTACHED != None:
            result += (
                ...
                + ("1" if self.FULLTEXTFILEATTACHED else "0")
                + ";"
            )
        ...
        if self.VARIANTSAMELEVEL != None:
            result += (
                "VARIANTSAMELEVEL=" + ("1" if self.VARIANTSAMELEVEL else "0") + ";"
            )
        if self.VARIANTSETACTIVE != None:
            result += (
                "VARIANTSETACTIVE=" + ("1" if self.VARIANTSETACTIVE else "0") + ";"
            )
        if self.VARIANTTRANSFERRETENTION != None:
            result += (
                "VARIANTTRANSFERRETENTION="
                + ("1" if self.VARIANTTRANSFERRETENTION else "0")
                + ";"
            )
        ...
        if self.KEEPLINKWHENEXISTS != None:
            result += (
                "KEEPLINKWHENEXISTS=" + ("1" if self.KEEPLINKWHENEXISTS else "0") + ";"
            )
        if self.DELETEVARIANTMODE != None:
            result += (
                "DELETEVARIANTMODE=" + ("1" if self.DELETEVARIANTMODE else "0") + ";"
            )
        if self.COPYINDEXONLY != None:
            result += "COPYINDEXONLY=" + ("1" if self.COPYINDEXONLY else "0") + ";"
        if self.COPYCREATEHISTORY != None:
            result += (
                "COPYCREATEHISTORY=" + ("1" if self.COPYCREATEHISTORY else "0") + ";"
            )
