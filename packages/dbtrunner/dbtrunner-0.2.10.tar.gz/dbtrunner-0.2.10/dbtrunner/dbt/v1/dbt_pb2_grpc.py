...
class DBTServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DebugCommand = channel.unary_unary(
...
def add_DBTServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DebugCommand': grpc.unary_unary_rpc_method_handler(
...
class DBTService(object):
    ...
    def RunCommand(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/dbt.v1.DBTService/RunCommand',
    ...
    def TestCommand(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/dbt.v1.DBTService/TestCommand',
    ...
    def DebugCommand(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/dbt.v1.DBTService/DebugCommand',
