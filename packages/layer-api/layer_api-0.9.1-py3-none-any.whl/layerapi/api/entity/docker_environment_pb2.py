...
from layerapi.value import docker_context_pb2 as api_dot_value_dot_docker__context__pb2
from layerapi.value import dockerfile_pb2 as api_dot_value_dot_dockerfile__pb2
