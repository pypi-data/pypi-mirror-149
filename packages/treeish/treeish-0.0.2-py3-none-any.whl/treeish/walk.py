...
def fetch_values_from_key(data: dict, key: str) -> Iterator:
    """
    Stack based function applicable to nested dictionaries to yield values that match the key;
    e.g. `fetch_values_from_key(data, "history")` will go through the nested dictionary searching for the "history" key.
