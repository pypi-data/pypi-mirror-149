...
class OrmWorkload(object):
    ...
    attribute_map = {
        ...
        'workload_experiment': 'workload_experiment',
    ...
    def __init__(self, created_dt=None, distributed_number=None, edges=None, endpoints=None, env_vars=None, exit_code=None, final_cost=None, id=None, kernel_cluster_select_policies=None, start_command=None, status=None, status_last_updated=None, status_reason=None, type=None, updated_dt=None, volume_mounts=None, workload_experiment=None, workload_kernel_cluster=None, workload_kernel_cluster_node=None, workload_kernel_image=None, workload_kernel_resource_spec=None, workload_workspace=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._workload_experiment = None
        ...
        self.workload_experiment = workload_experiment
        ...
        self.workload_workspace = workload_workspace
    ...
    @property
    def workload_experiment(self):
        """Gets the workload_experiment of this OrmWorkload.  # noqa: E501


        :return: The workload_experiment of this OrmWorkload.  # noqa: E501
        :rtype: int
        """
        return self._workload_experiment

    @workload_experiment.setter
    def workload_experiment(self, workload_experiment):
        """Sets the workload_experiment of this OrmWorkload.


        :param workload_experiment: The workload_experiment of this OrmWorkload.  # noqa: E501
        :type workload_experiment: int
        """

        self._workload_experiment = workload_experiment
    ...
    @property
    def workload_workspace(self):
        """Gets the workload_workspace of this OrmWorkload.  # noqa: E501


        :return: The workload_workspace of this OrmWorkload.  # noqa: E501
        :rtype: int
        """
        return self._workload_workspace

    @workload_workspace.setter
    def workload_workspace(self, workload_workspace):
        """Sets the workload_workspace of this OrmWorkload.


        :param workload_workspace: The workload_workspace of this OrmWorkload.  # noqa: E501
        :type workload_workspace: int
        """

        self._workload_workspace = workload_workspace
