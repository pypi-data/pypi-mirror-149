...
class ProtoVolumeMountRequest(object):
    ...
    def __init__(self, archive_file=None, code=None, dataset=None, dataset_version=None, empty_dir=None, local=None, model_volume=None, mount_path=None, mount_type=None, output=None, readonly=None, volume=None, local_vars_configuration=None):  # noqa: E501
    ...
    def mount_type(self, mount_type):
        ...
        allowed_values = ["empty-dir", "code", "archive-file", "dataset", "dataset-version", "output", "volume", "local", "model-volume"]  # noqa: E501
