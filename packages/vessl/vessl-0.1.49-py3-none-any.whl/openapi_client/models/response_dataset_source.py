...
class ResponseDatasetSource(object):
    ...
    def __init__(self, aws_role_arn=None, bucket_name=None, cluster_id=None, cluster_name=None, is_external=None, local_volume_config=None, minio_endpoint=None, path=None, type=None, local_vars_configuration=None):  # noqa: E501
