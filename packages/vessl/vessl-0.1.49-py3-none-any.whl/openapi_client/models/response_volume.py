...
class ResponseVolume(object):
    ...
    def __init__(self, bucket_name=None, created_dt=None, id=None, is_read_only=None, last_sync_time=None, local_volume_config=None, status=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
