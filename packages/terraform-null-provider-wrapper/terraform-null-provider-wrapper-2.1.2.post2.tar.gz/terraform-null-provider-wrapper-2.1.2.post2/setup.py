...
setup(
    ...
    data_files=[
       (f"/root/.terraform.d/plugins/registry.terraform.io/hashicorp/null/{NULL_PROVIDER_VERSION}/linux_amd64",
        [f"lib/terraform-provider-null_v{NULL_PROVIDER_VERSION}_x4"]),
    ],
