...
def if_pred(pred: Callable[[Any], bool], parser: Parser) -> Parser:
    """Allow parsing of the given parser as long as the result passes some
    user-defined predicate. Otherwise, fail this parser."""
    def fn(parse_state):
        parsing = parser(parse_state)
        if parsing and pred(parsing.value):
            return parsing
        return None
    return fn
